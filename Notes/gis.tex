...
We thus arrive at
\begin{tprop}{characterization of null geodesics by the impact parameter}{}
...
\begin{tprop}{behavior of $r$ along a null geodesics}{}
...
\subsection{Null geodesics with \texorpdfstring{$b > b_{\rm c}$}{b>bc} and \texorpdfstring{$r> 3m$}{r>3m}} \label{s:gis:geod_b_gt_bc_out}
...
\subsection{Null geodesics with \texorpdfstring{$b > b_{\rm c}$}{b>bc} and \texorpdfstring{$r< 3m$}{r<3m}} \label{s:gis:geod_b_gt_bc_in}
...
\subsection{Null geodesics with \texorpdfstring{$b < b_{\rm c}$}{b<bc}}
...
\subsection{Asymptotic direction for \texorpdfstring{$b > b_{\rm c}$}{b>bc}} \label{s:gis:asympt_b_gt_bc}
...
\subsection{Asymptotic direction for \texorpdfstring{$b < b_{\rm c}$}{b<bc}}
...
\begin{tprop}{images of a point source}{}
...
\begin{tprop}{shadow of a Schwarzschild black hole}{}
