...
Let us find explicit expressions for the three real zeros $u_{\rm neg}$,
...
\begin{align}
 ...
 & \encadre{ u_{\rm per} = \frac{1}{3}\cos\left[ \frac{2}{3} \arcsin\left(
   \frac{b_{\rm crit}}{b}\right) + \frac{4\pi}{3}\right] + \frac{1}{6} }\\[1ex]
 & \encadre{ u_{\rm apo} = \frac{1}{3}\cos\left[ \frac{2}{3} \arcsin\left(
   \frac{b_{\rm crit}}{b}\right) \right] + \frac{1}{6} } .
\end{align}
\end{subequations}
These zeros are plotted in term of $b$ on Fig. ??
Note the ordering
\be
...
\section{Polar equations of null geodesics}
...
$\tlamb\to +\infty$. Let us denote by $\tlamb_{\rm per}$ the value of the
