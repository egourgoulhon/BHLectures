...
Here we focus on the case $L\not= 0$ (``generic'' case). We may then
consider along the geodesic $\Li$
the affine parameter
\be
   \encadre{ \tilde{\lambda} := |L| \lambda },
\ee
instead of $\lambda$, which is the affine parameter associated with the 4-momentum $\w{p}$
...
Charles Galton Darwin\index{Darwin, C.G.} \cite{Darwi59}
...
\begin{hist}
In his 1921 treatise \cite{Laue1921}, Max von Laue\index{von Laue, M.}
...
Charles Galton Darwin\index{Darwin, C.G.} in 1959 \cite{Darwi59}. Actually,
...
computation of the shadow has been presented by James M.~Bardeen\index{Bardeen, J.M.}
...
which generalizes the Schwarzschild black hole to the rotating case (to be studied in Chap.~\ref{s:ker}).
\end{hist}
...
lying in some plane around the black hole. The inner radius of the disk
...
Jean-Pierre Luminet\index{Luminet, J.-P.} in 1979 \cite{Lumin79}, (see Ref.~\cite{Lumin19} for
...
In 1991, Jean-Alain Marck\index{Marck, J.-A.} computed the first movie of an observer plunging
into a Schwarzschild black endowed with an accretion disk \cite{Marck96}.
In 2007, Alain Riazuelo\index{Riazuelo, A.} computed the image of a
