...
along $\Li$ [Eq.~(\ref{e:ges:conserved_quantities})].
...
(compare Fig.~\ref{f:gis:eff_pot_bound}). Hence there are no bound orbits
...
Let us investigate the image on the distant observer's screen
...
sphere that is uniformly bright. In such a setting,
all values of $b > b_{\rm crit}$ on $\Obs$'s screen, whatever the angle $\alpha$,
correspond to a null geodesic that orginate from the shining sphere, while
...
up far away from the black hole, i.e. on the shining sphere, (ii) null geodesics
