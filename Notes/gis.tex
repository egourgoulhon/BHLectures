...
\ee
\item $\Li$ is \defin{outgoing}\index{outgoing!null geodesic}p: $r$ increases all along $\Li$; as shown in Sec.~\ref{s:ges:eq_to_be_solved}, this cannot happen in the region $r<2m$ (the black
...
\[
    \ph_\infty = \ph_{-\infty} + \eps_L (\Phi_b(0) + \Phi_b(0)) .
\]
Hence
