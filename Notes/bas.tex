...
\defin{curve}\index{curve} is a subset $\mathcal{C}\subset \M$ that is the image of a smooth function
$I \rightarrow  \M$:
\be
    \begin{array}{rccl}
...
\defin{parametrization}\index{parametrization} of $\mathcal{C}$ and the real
