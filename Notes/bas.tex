...
(cf.~Remark~\ref{r:bas:topol_manif}), meaning that one has the notion of continuity, but not of differentiability. To The concept of black holeprovide the latter, one should rely on the differentiable structure of $\R^n$, via the atlases:
