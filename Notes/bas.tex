...
(cf.~Remark~\ref{r:bas:topol_manif}), meaning that one has the notion of continuity, but not of differentiability. To provide the latter, one should rely on the differentiable structure of $\R^n$, via the atlases:
