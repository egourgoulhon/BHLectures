...
(resp. a \defin{spacelike coordinate}\index{spacelike!coordinate} or a \defin{null coordinate}\index{null!coordinate}) iff
...
\begin{remark}
Being timelike, spacelike or null is a property of the coordinate $x^\alpha$ per se (i.e. considering $x^\alpha$ as a scalar field $\M\to \R$); on the contrary the causal type of the coordinate vector $\wpar_\alpha$ depends on the
