...
we examine here the basic properties of this type of hypersurfaces. The results
established in this chapter are fully generic, i.e. they are valid for any
null hypersurface, not necessarily a black hole horizon.
...
Hereafter, we denote by $\Hor$ a generic null hypersurface in a $n$-dimensional spacetime
$(\M,\w{g})$.
...
\section{Cross-sections of a null hypersuface}
