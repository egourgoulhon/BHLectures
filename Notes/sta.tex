...
The coefficient $M$ that appears in the expression (\ref{e:sta:asymptotic_metric})
...
coincides in the limit $r\to +\infty$ with
the Komar mass over a sphere $\Sp$
of constant $(x^0,r)$,
where $r := \sqrt{(x^1)^2 + \cdots + (x^{n-1})^2}$.
In particular, for a weakly relativistic system, the Komar mass over a sphere at infinity is equal
to the integral of the matter energy density $T_{00}$, as given by formula
...
confusion with the asymptotic Minkowskian coordinates $(x^\alpha)$.
We have $\xi_\alpha = g_{\alpha\mu} \xi^\mu = g_{0\alpha}$,
with $g_{0\alpha}$ given by formulas (\ref{e:sta:asymptotic_metric}) for large $r$,
so that
\[
...
of the expansion (\ref{e:sta:metric_weakly_relat}) being a particular case of
