...
One may use it to ensure that the metric perturbation $\w{h}$ fulfills
\be
...
shows that, at the first order in $\w{h}$ and in the Lorenz gauge,
...
\ee
where $x$ stands for $(x^1, \ldots, x^{n-1})$, $y$ for $(y^1, \ldots, y^{n-1})$,
