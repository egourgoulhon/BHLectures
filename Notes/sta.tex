...
An elementary proof specific to the case $n=4$ can be found in Sec.~8.2 of the textbook
\cite{Strau13}.
...
dimensions $n\geq 4$ has been achieved by Seungsu Hwang in 1998 and

F. Tangherlini
\end{hist}

So basically, in dimension $n=4$,
