...
\]
where the last equality stems from the source-free Maxwell equation
...
us rewrite it in terms of some electromagnetic potential 1-form $\w{A}$ that
vanishes at infinity; we have then $F_{\rho\sigma} = \nabla_\rho A_\sigma
