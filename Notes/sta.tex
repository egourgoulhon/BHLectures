...
corresponding to a parameter $v$ of the generators connected to the parameter
$t$ of the stationary action, i.e. such that, along a given null generator
$\Li$, $v(\Phi_T(p)) = v(p) + T$. The vector $\w{\chi}$ is invariant
