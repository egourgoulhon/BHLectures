...
on $\Hor_{k}$; the zeroth law of black hole dynamics (Property~\ref{p:neh:zeroth_law})
implies then that $\kappa_{k}$ is constant.
The Komar mass $M_{\Hor_{k}}$ over any cross-section
