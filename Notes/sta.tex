...
We shall discuss in details the two cases, null or spacelike, for $\w{\xi}$
on $\Hor$ in Sec.~\ref{s:sta:EH_KH}. Here, we move to the topology of
...
(see also p.~34 of Ref.~\cite{Hawki73}), under the hypothesis of the
...
the analycity assumption and assuming the null energy
