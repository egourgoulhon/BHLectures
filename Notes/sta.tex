...
\subsubsection{Link with the ADM mass}
...
\ee
As the Komar mass $M_{\Sp}$, $J_{\Sp}$ does not depend on the choice of $\Sp$,
provided $\Sp$ lies in the vacuum region and $\w{g}$ obeys the Einstein equation.
