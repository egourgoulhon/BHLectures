...
the Komar current $\w{\mathcal{J}}[\w{\xi}]$ associated to a Killing vector $\w{\xi}$ is, up to some factor, the
...
These authors have shown that the theorem holds in gravity theories with actions
involving quadractic and higher orders combinations of the curvature tensor.
