...
in dimension $n=5$, there
exist stationary black holes, the event horizon of which has two connected
components: they are the \emph{black saturns}\index{black!saturn}
found by H.~Elvang and P.~Figueras (2007) \cite{ElvanF07}. The topology of the first
connected component, $\Hor_{\rm p}$ say, is $\R\times\SS^3$ (the ``planet'')
and that of the second component, $\Hor_{\rm r}$ say, is $\R\times\SS^1\times\SS^2$
(the ``ring''). For both $\Hor_{\rm p}$ and $\Hor_{\rm r}$, $L=1$ and
...
\begin{prop}
Let $(\M,\w{g})$ be a $n$-dimensional spacetime
\end{prop}
