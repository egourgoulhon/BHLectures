...
examine successively the only two allowed cases for
the event horizon $\Hor$ of a stationary black hole:
...
is null on all $\Hor$, then $\Hor$ is a Killing horizon with respect to $\w{\xi}$.
\end{prop}
