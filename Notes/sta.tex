...
is that of $\Sp$ having the topology of the 2-torus $\mathbb{T}^2 = \SS^1\times\SS^1$. It could occur only under special circumstances,
...
condition, which is weaker than the dominant energy condition (hypothesis (i) above),
