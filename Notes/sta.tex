...
\ee
The constant $\Omega_H$ is then called \defin{black hole rotation velocity}\index{black hole!rotation velocity}\index{rotation!velocity} if $\Hor$ coincides with
