...
Wald\index{Wald, R.M.} (Theorem~4.2 in Ref.~\cite{ChrusW94}),
...
to any dimension $n \geq 4$. Actually, the proof given above\footnote{The first part of the proof,
...
The theorem was restated and proved without the last hypothesis
in Hawking \& Ellis'\index{Ellis, G.} famous textbook published in 1973 \cite{HawkiE73}
(Proposition 9.3.6).
Some details have been fixed
