...
\begin{hist}
The first hints towards the no-hair feature of black holes appeared in 1964-65 from
...
the deformations away from spherical symmetry in the external metric
dying out as the black hole forms. These authors have also shown in the same article~\cite{DorosZN65} that any static quadrupolar
deformation of the Schwarzschild metric lead to a curvature singularity at the event horizon.
...
in his famous 1967 work \cite{Israe67} yielding to the theorem that bares his name
(Property~\ref{p:sta:Israel_uniqueness_thm}).
In 1968, Brandon Carter\index[pers]{Carter, B.} \cite{Carte68a}
conjectured that the Kerr solution --- which contains the Schwarzschild one as
the nonrotating subcase --- may represent all stationary black holes.
