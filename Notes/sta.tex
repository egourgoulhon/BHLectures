...
are obtained from $p_0$ and $q_0$ by displacement along $\wl$ (by a parameter $\delta\lambda= 1$),
...
We first define $\w{\chi}$ on $\Hor$ only, by demanding that $\w{\chi}$  is the vector tangent to the null generators of $\Hor$
...
along a null generator $\Li$. We require the supplementary condition that
