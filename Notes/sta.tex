...
(Property~\ref{p:sta:Israel_uniqueness_thm}).
...
(Box~33.1). In a 1996 interview, Wheeler \cite{Wheel96} stated that Jakob Bekenstein\index[pers]{Bekenstein, J.} (then his PhD student) coined that phrase.
...
(Property~\ref{p:sta:strong_rigidity_thm}). Indeed the latter basically states that all stationary black holes are necessarily axisymmetric and a year before, Brandon Carter \cite{Carte71}
showed that all axisymmetric stationary and 4-dimensional black holes belong either to the
...
Obviously the no-hair theorem is revelant for actual black holes in Nature
as long as its hypotheses, some of them being quite strong, are fulfilled.
In 1994, Piotr Chru\'sciel\index[pers]{Chrusciel, P.T.@Chru\'sciel, P.T.} \cite{Chrus94}
critically reviewed the no-hair theorem, pointing out that it is

For further details, see the historical accounts by Carter \cite{Carte99} and Robinson \cite{Robin09}.
\end{hist}
