...
and Tetsuya Shiromizu\index{Shiromizu, T.} in 2002 \cite{GibboIS02b}.
...
with $K=1$ is a valid static solution of the electrovacuum Einstein equation as well. It is
...
of the Einstein-Maxwell system with a vanishing magnetic monopole charge ($P=0$) has been found independently by Hans Reissner\index{Reissner, H.}
...
in 1947 independently by Sudhansu Datta Majumdar\index{Majumdar, S.D.} \cite{Majum47}
and Achilles Papapetrou\index{Papapetrou, A.} \cite{Papap47}, as solutions of the electrovacuum
...
and analyzed by James Hartle\index{Hartle, J.B.} and Stephen Hawking\index{Hawking, S.W.}
in 1972 \cite{HartlH72}. The generalization of the Majumdar-Papapetrou solution
to spacetime dimensions $n > 4$ is due to Robert Myers\index{Myers, R.C.} in 1987
\cite{Myers87}.
\end{hist}

\begin{hist}[uniqueness theorems for static electrovacuum black holes]
The part (i) with $P=0$ (i.e. the Reissner-Nordström black hole with no magnetic charge) of the 4-dimensional uniqueness theorem~\ref{p:sta:Israel_uniq_electrovac_n4}
has been first proven by Werner Israel\index{Israel, W.}
...
Abul Masood-ul-Alam\index{Masood-ul-Alam, A.K.M.} in 1992 \cite{Masoo92}.
The allowance for a magnetic charge ($P\neq 0$) has been acheived by Markus Heusler\index{Heusler, M.} in 1994 \cite{Heusl94} (see also Sec.~9.4 of Ref.~\cite{Heusl96}).
Three years later, he obtained part (ii) of the theorem (i.e. the Majumdar-Papapetrou black hole)
by assuming that all the connected components of $\Hor$ are degenerate \cite{Heusl97}.
This assumption has been relaxed by
Piotr Chru\'sciel\index{Chrusciel, P.T.@Chru\'sciel, P.T.} and Paul Tod\index{Tod, P.}
...
has been established by Gary Gibbons\index{Gibbons, G.W.}, Daisuke Ida\index{Ida, D.}
and Tetsuya Shiromizu\index{Shiromizu, T.} in 2002 \cite{GibboIS02a}
with the extra assumption of a vanishing magnetic field. This assumption
has been relaxed by Hari Kunduri\index{Kunduri, H.K.} and James Lucietti\index{Lucietti, J.}
