...
is the horizon area). Then Carter has been able to show that the solutions
...
by some \emph{tour de force} \cite{Carte97}
could show that the solution has to belong to the Kerr family.
The electrovacuum case turned out to be too complicated for the technique
used by Robinson. New techniques have been introduced independently
...
\begin{prop}[no-hair theorem\index{no-hair theorem} (vaccum)]
