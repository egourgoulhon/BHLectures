...
We shall check below that, for a weakly relativistic system, the Komar mass
...
Let $(\M,\w{g})$ be a $n$-dimensional stationary spacetime, with stationary Killing vector
$\w{\xi}$, that is weakly relativistic
