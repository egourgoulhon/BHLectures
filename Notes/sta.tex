...
\be \label{e:sta:Schwarz_Tang}
    ...
    + r^2 \w{q} ,
\ee
where $\w{q}$ is the standard round metric\footnote{
$\w{q} = \dd\th_1^2 + \sin^2\th_1 \dd\ph^2$ for $n=4$,
$\w{q} =  \dd\th_1^2 + \sin^2\th_1( \dd\th_2^2 + \sin^2\th_2 \dd\ph^2 )$
for $n=5$, etc.}
...
\end{itemize}
then the domain of outer communications $\langle\langle \M\rangle\rangle$ of $(\M,\w{g})$ is isometric
to the domain of outer communications of a $n$-dimensional Reissner-Nordström spacetime\index{Reissner-Nordström!spacetime} with vanishing magnetic monopole, i.e. there exists a coordinate system
\end{prop}
