...
has the topology of the sphere $\SS^2$ (one says that $\Sp$ is
...
The theorem is therefore valid for future outer trapping horizons \cite{Haywa94}
and apparent horizons, as noticed by Hawking himself \cite{Hawki73}.
\end{remark}
