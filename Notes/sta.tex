...
The coordinates $(x^i)_{1\leq i \leq n-1}$ form a
...
and $\Omega_{n-2}$ is the area of the sphere $\SS^{n-2}$; the latter is given by the formula
...
The quantities $M$ and $J_{ij}$ are independent of $\Sigma$ and are
called respectively the \defin{mass} and
...
field and the Gauss-Ostrogradsky theorem allows one to set it to zero.
