...
via some \emph{tour de force} \cite{Carte99}, showed
...
showed that electrovaccuum rotating black holes with a degenerate horizon
...
\begin{hist}
The first hints towards the no-hair property appeared in 1964-65 from
studies by Vitaly Ginzburg\index[pers]{Ginzburg, V.L.}
and by Andrei Doroshkevich\index[pers]{Doroshkevich, A.G.}, Yakov Zeldovich\index[pers]{Zeldovich, Ya.B.} and Igor Novikov\index[pers]{Novikov, I.D.} .
In the first study \index{Ginzb64}, Ginzburg showed that the gravitational collapse of a magnetized
star gives birth to an unmagnetized black hole. In the second study \cite{DorosZN65},
Doroshkevich, Zeldovich and Novikov showed
that the gravitational collapse of a initially static body that slightly departs from spherical symmetry leads to a perfectly spherical black hole (i.e. a Schwarzschild black),
i.e. that the deformation away from spherical symmetry dies out as the black hole forms
(cf.  Chap.~7 of Thorne\index[pers]{Thorne, K.S.}'s book \cite{Thorn94} for more details).
In 1967, by establishing in that the Schwarzschild black hole is the only static black hole solution in general relativity, Werner Israel\index[pers]{Israel, W.}
\cite{Israe67} put this result on firm grounds.
A year after, Brandon Carter\index[pers]{Carter, B.} \cite{Carte68a}
conjectured that the Kerr solution may represent all stationary black holes.
The uniqueness property became then known as the
\emph{Carter-Israel conjecture}\index{Carter-Israel conjecture}.

The phrase \emph{``a black hole has no hair''} has been popularized by
John Wheeler\index[pers]{Wheeler, J.A.} (see e.g. Box~33.1 of \cite{MisneTW73});
