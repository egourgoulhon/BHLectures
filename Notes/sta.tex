...
Thanks to a theorem by P.T.~Chru\'sciel\index{Chrusciel, P.T.@Chru\'sciel, P.T.} \&
R.M.~Wald\index{Wald, R.M.} (Theorem~4.2 in Ref.~\cite{ChrusW94}),
...
\begin{remark}
Sudarsky \& Wald stated the staticity theorem for $n=4$ but, as pointed out in
Refs.~\cite{ChrusLH12} and \cite{HollaI12}, the theorem straightforwardly generalizes
to any dimension $n \geq 4$. Actually, the proof given above (which is slightly different
from Sudarsky \& Wald's one) does not assume $n=4$.
\end{remark}
...
\begin{hist}
Stephen Hawking\index{Hawking, S.} first established this theorem in 1972 \cite{Hawki72}
for a spacetime of dimension $n=4$. Some details have been fixed
