...
\begin{prop}[topology theorem 2 \textnormal{(Chru\'sciel\index[pers]{Chrusciel, P.T.@Chru\'sciel, P.T.} \& Wald\index{Wald, R.M.} 1994 \cite{ChrusW94b})}]
...
\cite{HawkiE73}).
However, in 1993, Gregory Galloway\index[pers]{Galloway, G.J.} \cite{Gallo94}
...
John L. Friedman\index[pers]{Friedman, J.L.}, Kristin Schleich\index{Schleich, K.}
...
by J. Ehlers\index[pers]{Ehlers, J.} and J.L. Stachel\index{Stachel, J.L.} and published in 1969 \cite{Boyer69}.
\end{hist}
...
and by Vincent Moncrief\index{Moncrief, V.} and James Isenberg\index[pers]{Isenberg, J.}
...
In 1999, H. Friedrich\index[pers]{Friedrich, H.}, I. Rácz\index{Racz, I.@R\'acz, I.},
...
by Rabin Banerjee\index[pers]{Banerjee, R.}, Bibhas Majhi\index{Majhi, B.R.}, Sujoy Modak\index{Modak, S.K.}, and Saurav Samanta\index{Samanta, S.}
...
no-hair theorem\index{no-hair theorem}.
...
on the equilibrium state (non-rotating, i.e. static, versus rotating),
...
in any spacetime dimension (Sec.~\ref{s:sta:uniqueness_static}), before focusing
on ''the'' no-hair theorem itself, which regards rotating black holes in dimension 4
...
and/or to degenerate horizons and we shall present these generalized versions.
...
and \ref{p:sta:topology2}), which has been established 5 years later by Stephen Hawking\index[pers]{Hawking, S.W.} \cite{Hawki72}, so it can be removed from the hypotheses of the theorem. The requirement (ii) ($\Hor$ connected)
has been removed as unecessary by Gary Bunting\index[pers]{Bunting, G.} and
...
Piotr Chru\'sciel\index[pers]{Chrusciel, P.T.@Chru\'sciel, P.T.} and Paul Tod\index{Tod, P.}
...
has been relaxed by Hari Kunduri\index[pers]{Kunduri, H.K.} and James Lucietti\index{Lucietti, J.}
in 2018 \cite{KunduL18}.
\end{hist}



\subsection{The no-hair theorem} \label{s:sta:the_no-hair_thm}
...
\textnormal{(Carter\index[pers]{Carter, B.} 1971 \cite{Carte71}, Robinson\index{Robinson, D.C.} 1975 \cite{Robin75})}]
