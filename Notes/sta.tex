...
and, at the limit $r\to+\infty$, $\sqrt{q} = r^{n-2} \sqrt{\bar{q}}$,
...
\]
Now by the very definition of $\Omega_{n-2}$ as the area of $\SS^{n-2}$, we
have, given expression (\ref{e:sta:sqrt_barq_spher}) for $\sqrt{\bar{q}}$,
