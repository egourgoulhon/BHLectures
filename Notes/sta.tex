...
it, Eqs.~(\ref{e:sta:ReiNor_n4})-(\ref{e:sta:F_ReiNor_n4}) still define a valid
...
spanned by the coordinates $(\th_1,\ldots,\th_{n-3},\ph)$,
and the constants $\mu>0$ and $q\geq 0$ are related to the Komar mass at infinity (or ADM mass)
$M$ and electric charge $Q$ by
\be
    \mu = \frac{16\pi M}{(n-2) \Omega_{n-2}}
    \qand
