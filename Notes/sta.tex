...
to the domain of outer communications of a \defin{$n$-dimensional Schwarzschild spacetime}\index{Schwarzschild!spacetime}, also known as a \defin{Schwarzschild-Tangherlini spacetime}\index{Schwarzschild-Tangherlini spacetime}. This means that there exists a coordinate system
...
and $P$ is its magnetic monopole charge (cf. Remark~\ref{r:sta:magnetic_monopole} below).
...
(\ref{e:sta:g_ReiNor_n4})-(\ref{e:sta:F_ReiNor_n4}) shows, a black hole with a non-vanishing
...
it, Eqs.~(\ref{e:sta:g_ReiNor_n4})-(\ref{e:sta:F_ReiNor_n4}) still define a valid
...
spacetime}\index{extremal!Reissner-Nordström
spacetime}, i.e. a solution (\ref{e:sta:g_ReiNor_n4})-(\ref{e:sta:F_ReiNor_n4}) for which $|Q| = \sqrt{4\pi/\mu_0} \, M$ and $P=0$, or equivalently a
...
(\ref{e:sta:MajPap_n4})-(\ref{e:sta:U_MajPap_n4}) coincides with the
Reissner-Nordström solution (\ref{e:sta:g_ReiNor_n4})-(\ref{e:sta:F_ReiNor_n4})
...
\defin{$n$-dimensional Reissner-Nordström spacetime}\index{Reissner-Nordström!spacetime} with vanishing magnetic monopole, also known as a
...
\begin{example}
For $n=5$, $\Omega_{n-2} = \Omega_3 = 2\pi^2$ and Eqs.~(\ref{e:sta:g_ReiNorTang})-(\ref{e:sta:F_ReiNorTang}) become
\[
...
\begin{hist}
The Reissner-Nordström solution (\ref{e:sta:g_ReiNor_n4})-(\ref{e:sta:F_ReiNor_n4})
of the Einstein-Maxwell system with a vanishing magnetic monopole ($P=0$) has been found independently by Hans Reissner\index{Reissner, H.}
in 1916 \cite{Reiss1916}, Hermann Weyl\index{Weyl, H.} in 1917 \cite{Weyl1917}
and Gunnar Nordström\index{Nordström, G.} in 1918 \cite{Nords1918}.
The generalization to $P\neq 0$ can be found in Brandon Carter's\index{Carter, B.}
lecture at Les Houches (1972) \cite{Carte73a}.
The generalization to dimensions $n > 4$ with $P=0$, i.e. the solution
(\ref{e:sta:g_ReiNorTang})-(\ref{e:sta:F_ReiNorTang}),
