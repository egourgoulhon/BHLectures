...
\ee
Then, one can show (see e.g. Sec.~1.9 of Straumann's textbook \cite{Strau04}), that locally, there exists a coordinate system $(x^\alpha)=(t,x^1,\ldots,x^{n-1})$ such that
