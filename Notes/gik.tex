...
of a Kerr black hole have been found by James M. Bardeen\index[pers]{Bardeen, J.M.}, William H. Press\index{Press, W.H.} and Saul A. Teukolsky\index{Teukolsky, S.A.} in 1972 \cite{BardePT72}.
...
first by James M.~Bardeen\index[pers]{Bardeen, J.M.} in 1972 \cite{Barde73}
...
has been coined by Heino Falcke\index[pers]{Falcke, H.}, Fulvio Melia\index{Melia, F.} and Eric Agol\index[pers]{Agol, E.} in 2000 \cite{FalckMA00}, cf. the historical note on p.~\pageref{h:gik:disk_images}.
\end{hist}
...
In 2000, Heino Falcke\index[pers]{Falcke, H.}, Fulvio Melia\index{Melia, F.} and Eric Agol\index[pers]{Agol, E.}
