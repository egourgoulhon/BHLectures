...
of the Southern hemisphere ($\D\th/\D\lambda>0$).
The left panel corresponds to $0 \leq \lambda \leq 3$,
while the right one extends the range to $0 \leq \lambda \leq 20$.
...
$0 \leq \lambda \leq 20$. Also shown is the Northern vortical circular photon orbit
