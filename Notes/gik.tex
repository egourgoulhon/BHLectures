...
are unphysical, so that only values of $r_0$ for which the blue curve lies
...
the general solution to the system (\ref{e:gik:R_Rp_r0_zero}), but not all
