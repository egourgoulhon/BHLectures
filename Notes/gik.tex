...
a reconstructed image, after more than one year of data processing
of an incomplete data set in the image Fourier plane obtained
...
to the large relativistic jet\index{jet} emanating from the close vicinity of the black hole\footnote{This jet has
...
since most (all?) theoretical models predict that the jet is alined with
...
factor $m/r_{\Obs} = 3.7 \; \mu{\rm as}$ read in Table~\ref{t:gik:scale_factor}.
