...
In all $\M_{\rm II}$, $r$ decreases and reaches $r_-$. There $\Li$
...
towards the future into this region (this follows from the hypersurfaces
...
by $\Hor_{\rm in}$: it contains another null hypersurface that separates
$\M_{\rm III}$ from a ``time-reversed'' copy of $\M_{\rm II}$ region in the
maximally extended Kerr spacetime, cf. Fig.~\ref{f:ker:max_ext}, where
the ``time-reversed'' copy of $\M_{\rm II}$ is denoted by ${\M_{\rm II}^*}'$.
So actually, when it reaches $r=r_-$, the null geodesic $\Li$ enters
${\M_{\rm II}^*}'$. There $r$ must be increasing towards the future, at
the opposite of $\M_{\rm II}$. It reaches then $r=r_+$, where $\Li$
crosses a white hole\index{white hole} horizon and emerges into
the asympototically flat region $\M_{\rm I}''$, cf.
Fig.~\ref{f:gik:zero_ener_traj}.
...
and taking into account $Q > 0$, we get
\begin{greybox}
