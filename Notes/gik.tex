...
\ee
This follows immediately from Property~\ref{p:gek:latitudinal_motion},
...
We conclude:
\begin{tprop}{null geodesic with $E=0$ and $Q=0$}{}
...
\begin{tprop}{negative angular momentum for zero-energy null geodesics}{}
...
\subsection{Equations of geodesic motion for \texorpdfstring{$E\neq 0$}{E nonzero}} \label{s:gik:eom_Enonzero}
...
\begin{texample}{principal null geodesic}{}
...
$\mu=0$ and $E\neq 0$, we get
\begin{tprop}{latitudinal motion of null geodesics}{}
\begin{itemize}
...
following lemma:
\begin{tlemma}{behavior of $\mathcal{R}(r)$ in $\M_{\rm I}$}{gik:lem_R_r}
...
\begin{tprop}{$r$-turning points of null geodesics}{}
...
\begin{tprop}{radial behavior of null geodesics}{}
...
\begin{texample}{principal null geodesics}{gik:png_R_positive}
...
Hence we conclude:
\begin{tprop}{zero-energy spherical photon orbits}{}
...
\begin{tprop}{spherical photon orbits with $E\neq 0$}{}
...
\begin{tprop}{energy sign of spherical photon orbits}{gik:sign_E_ph_orbit}
...
\begin{tprop}{sign of $\ell$ for spherical photon orbits}{}
\begin{itemize}
...
\begin{tprop}{latitudinal behavior of spherical photon orbits}{}
\begin{itemize}
...
In addition, we have
\begin{tprop}{periodicity of the $\th$-motion}{}
...
\begin{texample}{outer spherical photon orbits}{gik:outer_spher}
...
\begin{texample}{inner spherical photon orbits}{}
...
\begin{tprop}{circular photon orbits in Kerr spacetime}{}
...
\begin{tprop}{stability criterion for spherical photon orbits}{}
...
\begin{tprop}{instability of spherical photon orbits in the black hole exterior}{}
...
\begin{tprop}{stability region for spherical photon orbits}{}
\be
...
We conclude:
\begin{tprop}{stability of spherical photon orbits}{}
...
\begin{tprop}{characterization of marginally stable spherical photon orbits}{}
...
\begin{tprop}{radial motion of critical null geodesics}{}
...
\begin{texample}{}{gik:critical_geod}
...
Hence we conclude:
\begin{tprop}{black spot in the image and black hole shadow}{}
...
We conclude:
\begin{tprop}{photon ring and critical curve}{}
