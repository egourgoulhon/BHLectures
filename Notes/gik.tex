...
Image of a thick accretion disk around a Kerr black bole with $a=0.95\, m$
computed by the ray-tracing code \textsf{Gyoto} for three inclination angles of the
observer $\th_{\Obs}$. The right column shows the critical curve (red dashed line)
superposed on the image. The critical curves are the same as in Fig.~\ref{f:gik:shadow_a95}.
\textsl{[Right-column figures generated by the notebook \ref{s:sam:Kerr_images}]}
}
\end{figure}
...
Same as Fig.~\ref{f:gik:img_disk_a95} but for $a = 0.50\, m$.
}
\end{figure}
...
Figures~\ref{f:gik:img_disk_a95} and \ref{f:gik:img_disk_a50}
...
ISCO (cf. Sec.~\ref{s:gek:circ_orb_stab}), which is $r_{\rm ISCO}^+ \simeq 1.937\, m$
for $a=0.95\, m$ (Fig.~\ref{f:gik:img_disk_a95}) and
$r_{\rm ISCO}^+ \simeq 4.233 \, m$
for $a=0.50\, m$ (Fig.~\ref{f:gik:img_disk_a50}).


For a detailed study see Ref.~\cite{GrallL20a}.
