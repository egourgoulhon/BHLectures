...
\begin{itemize}
\item $\mathcal{R}(r)$ has no root and $\mathcal{R}(r) > 0$
(Fig.~\ref{f:gik:R_in_M1}a);
\item $\mathcal{R}(r)$ has a double root, at $r=r_0$ say, and
$\mathcal{R}(r) > 0$ iff $r\in(r_+, r_0)$ or $r\in(r_0, +\infty)$
(Fig.~\ref{f:gik:R_in_M1}b);
\item $\mathcal{R}(r)$ has two simple roots, at $r=r_1$ and $r=r_2$ say, and
$\mathcal{R}(r) > 0$ iff $r\in(r_+, r_1)$ or $r\in(r_2, +\infty)$
(Fig.~\ref{f:gik:R_in_M1}c);
\item $\mathcal{R}(r)$ has a unique simple root, at $r=r_0$ say; then
...
Given the above boundary conditions it is possible that $\mathcal{R}(r)$ has
a unique simple root $\M_{\rm I}$ only if $\mathcal{R}(r_+) = 0$ (cf. Fig.~\ref{f:gik:R_in_M1}d),
which occurs for a very specific value of $\ell$, namely $\ell = (r_+^2 + a^2)/a = 2 m r_+/a$.
Similarly, the case of three roots in $\M_{\rm I}$, either three simple roots or one double and one simple root,
is compatible with the boundary conditions only if $\mathcal{R}(r_+) = 0$, i.e.
if $r_+$ is a fourth root of $\mathcal{R}$.
...
For the same reason, there cannot be four roots of $\mathcal{R}(r)$ in $\M_{\rm I}$.
There remains then only the first three cases of the lemma statement, which are compatible
