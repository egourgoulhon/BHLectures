...
(\ref{e:gik:screen_alpha_beta}). The shadow boundary is then obtained by
...
& \beta = \beta_{\rm c}(r_0) := \frac{\eps_\th}{r_{\Obs}}
    ...
    - \frac{\ell_{\rm c}(r_0)^2}{\sin^2\th_{\Obs}} \right) } .
\end{align}
\end{subequations}
This provides the equation of the shadow boundary in parametric form,
...
is therefore necessarily a disk. The shadow boundary is then a circle.
Its
