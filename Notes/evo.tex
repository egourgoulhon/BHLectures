...
(see e.g. \cite{Wald94}). It has not been derived from any quantum theory of gravity, i.e. the background spacetime $(\M,\w{g})$ is not quantized. One may say that Hawking radiation is a prediction of \emph{semiclassical gravity}\index{semiclassical gravity}.
\end{remark}
...
Hawking tried to rederive the effect using a different approach
of quantum field theory in curved spacetime and he realized that superradiance
is not at all required for particle creation: the spontaneous radiation takes place even for
a nonrotating black hole, which has no outer ergoregion and thus cannot trigger
any Penrose/superradiance process. This fantastic discovery was presented
in short article published in early 1974 \cite{Hawki74} and the computations were detailled in a subsequent one published in 1975 \cite{Hawki75}. Both articles give formula (\ref{e:evo:Hawking_temp})
...
state of the black hole, according to Boltzmann formula\index{Boltzmann formula}:
\be
...
The computations are easier for these black holes because their near-horizon geometries
have additional symmetries, as we have seen for the extremal Kerr black hole
