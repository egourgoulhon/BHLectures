...
The fact that the entropy of black holes is proportional to their area, as exhibited by the
...
consequences, being at the root of a major concept in contemporary
theoretical physics, namely the \defin{holographic principle}\index{holographic principle}.
...
that makes a gauge theory without gravity (CFT) equivalent to a gravity theory (strings in AdS),
and is pivotal in considerations about quantum gravity\index{quantum gravity}.


By itself, the Bekenstein-Hawking formula suggests that the (quantum) microscopic degrees of
...
a more general entropy bound, also derived from the GSL, called the \defin{Bekenstein bound}\index{Bekenstein}\index[pers]{Bekenstein, J.D.}  \cite{Beken81}. The latter states that
