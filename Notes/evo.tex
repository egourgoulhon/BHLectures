...
The entropy being proportional to the area, as exhibited by the
Bekenstein-Hawking formula (\ref{e:evo:S_BH}), is definitely a peculiarty
of black holes: ordinary physical systems have an entropy that scales with
their \emph{volume}, not their \emph{area}. This feature turned out to have profound
...
can be entirely described in terms of the fundamental degrees of freedom at the boundary
...
\begin{proof}
Let us assume that (\ref{e:evo:spher_ent_bound}) is violated. Then by throwing
a sufficient large amount of matter to the system, one may increase its mass
until it collapse to a black hole.
\end{proof}

\begin{remark}
For weakly gravitating systems, Property~\ref{p:evo:spher_ent_bound} can be shown to follow from
a more general entropy bound, called the \defin{Bekenstein bound}\index{Bekenstein}\index[pers]{Bekenstein, J.D.}  \cite{Beken81}, namely
$S \leq 2\pi k_{\rm B} R E/\hbar$, where $E$ is the total energy of the system and
$R$ the radius of a sphere that encloses it. The Bekenstein bound is also derived
from the GSL \cite{Beken81}.
\end{remark}
...
A famous realization of the holographic principle is the AdS/CFT correspondance,
