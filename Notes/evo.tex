...
\subsection{Beyond general relativity: Wald entropy and generalizations}
...
substituting the Einstein tensor $\w{G}$ by the energy-momentum tensor of the electromagnetic field
...
Among the three laws, the first one is thus the most sensitive to
the theory of gravity. Contemplating its expression (\ref{e:evo:first_law}),
one may wonder whether the term
$\frac{\kappa}{8\pi} \, \delta A$
could be changed to something else when one deviates from general relativity.
If the new term is of the form $\kappa \, \delta(...)$,
