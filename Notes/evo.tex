...
is equivalent to a certain string theory in a $(n+1)$-dimensional anti-de Sitter\index{anti-de Sitter spacetime} (AdS)\index{AdS} spacetime $\mathscr{B}$, the conformal boundary of which is\footnote{From Example~\ref{x:glo:AdS} on p.~\pageref{x:glo:AdS},
