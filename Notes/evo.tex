...
A standard computation (see e.g \cite{Compe19}) enables one to write the
variation of the Lagrangian $n$-form resulting from a generic variation $\delta\w{g}$ of
...
Note that $\w{\Theta}$ is not uniquely determined by
