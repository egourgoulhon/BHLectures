...
black holes. The identification $T\propto \kappa$ arises with the Hawking radiation,
...
computation of the Hawking radiation \cite{Hawki75} (cf. historical note on p.~\pageref{h:evo:Hawking_rad}).
\end{hist}
