...
\be \label{e:evo:Hawking_rad_power}
    L = \alpha \frac{\hbar}{M^2} ,
\ee
with $\alpha = 9 / (20480\pi) \simeq 1.40\; 10^{-4}$.
...
\be \label{e:evo:t_evap}
    t_{\rm evap} = \frac{M_0^3}{3\alpha\hbar} .
\ee
With $\alpha$ given by
...
\ee
For an astrophysical black hole ($M_0 >  1 M_\odot$), this is a huge duration, many
...
does not play any role on the black hole dynamics. Hawking radiation becomes relevant only when
...
and a black hole of that mass has a Schwarzschild radius
...
i.e. black holes of subsolar mass that could have formed in the primordial universe
...
In other words, the horizon area decreases as a consequence of Hawking radiation.
This seems to contradict the area theorem (Property~\ref{p:evo:area_thm}).
Actually there is no logical contradiction since one of the hypotheses of
the area theorem is not fulfilled for evaporating black holes, namely
the null convergence condition. Indeed, the effective energy-momentum tensor of
the quantum fields that generates the Hawking radiation does not obey the
