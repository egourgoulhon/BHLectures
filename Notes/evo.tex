...
\begin{tprop}{area theorem\index{area!theorem} \textnormal{(Hawking\index[pers]{Hawking, S.W.} 1971 \cite{Hawki71},
...
\begin{tprop}{generalized second law of thermodynamics (GSL)
 \textnormal{(Bekenstein\index[pers]{Bekenstein, J.D.} 1973 \cite{Beken73b,Beken74})}}{evo:GSL}
...
for any physical system, not necessarily a black hole:

\begin{tprop}{spherical entropy bound
\textnormal{(Susskind\index[pers]{Susskind, L.} 1995 \cite{Sussk95})}}{evo:spher_ent_bound}
