...
is below $2\; 10^{13}{\rm\; kg}$ so that electrons shall be included into the Hawking radiation
(cf. Remark~\ref{r:evo:comp_Hawking_rad}) and even muons. However, this provides a good estimate, a precise computation leading to \cite{MacGiCP08}
\be
    t_{\rm evap} < t_{\rm Univ} \iff M_0 < 5.00\; 10^{11} {\rm\; kg} .
\ee
This value corresponds to the mass of an asteroid of half-kilometer size.
