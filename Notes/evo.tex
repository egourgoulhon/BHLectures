...
\begin{example} \label{x:evo:EH_Lagrangian}
...
the metric tensor can always be written as \cite{IyerW94,Compe19}
...
The extremalization of the action (\ref{e:evo:action_L}) is equivalent to
$\int_\M \delta\w{L} = 0$. Now the part $\dd\w{\Theta}$ of $\delta\w{L}$ in
