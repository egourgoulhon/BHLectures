...
obtained, based on two current approaches to quantum gravity: string theory and loop quantum
gravity. Regarding the former, Andrew Strominger\index[pers]{Strominger, A.} and Cumrun Vafa\index[pers]{Vafa, C.} \cite{StromV96} have established
...
discussed in the review articles \cite{Horow98,Carli14,Wald01,Walla19}; they are
