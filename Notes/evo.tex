...
$k_{\rm B}$ is the Botlzmann constant. $T_{\rm H}$ is called the
...
\begin{remark}
The Hawking radiation is independent from any field equation for the
metric $\w{g}$. In particular it is idenpendent from the Einstein equation.
Moreover, the Hawking temperature formula is independent from the spacetime dimension.
\end{remark}

\begin{remark}
The Hawking temperature $T_{\rm H}$ is the radiation temperature measured
infinitely far from the black hole, not in its the vinicity.
...
also experiency a diverging acceleration [cf. Eq.~(\ref{e:neh_diverging_accel})].
On the contrary, an observer freely falling into the black hole, measures
$T=0$, i.e. does not detect the Hawking radiation, even when encountering
the event horizon.
\end{remark}


\begin{remark}
Composition of Hawking radiation: elementary particles of rest mass $m$ only for
$k_{\rm B} T > m$; high spin particles for rapidly rotating BH
\end{remark}
...
\begin{remark}
Negative specific heat capacity, as any gravitational system
\end{remark}
