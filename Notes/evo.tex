...
Bekenstein-Hawking formula (\ref{e:evo:S_BH}), is definitely a peculiarity
...
This principle states that all physical processes in a given region
...
freedom of a black hole (cf. Sec.~\ref{s:evo:quantum_entropy}) somehow reside on the black hole's boundary and not in
...
\begin{remark}
As its formulation may have suggested (``approximately spherically symmetric'', ``enclosed in a sphere''),
