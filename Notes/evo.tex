...
thermodynamically reversible transformation, provided that $\Omega_{\Hor}$ stands for
the star angular velocity. This strengthened the analogy between the reversibility in
...
\begin{hist}
In 1970-71, the discovery by Roger Penrose\index[pers]{Penrose, R.}, Roger Floyd\index[pers]{Floyd, R.M.}
and Demetrios Christodoulou\index[pers]{Christodoulou, D.} of
...
Moreover, by means of some more or less heuristic arguments, Bekenstein stated that the relation
between $S$ and $A$ must be $S = \eta k_{\rm B} A/(4\pi\hbar)$, where $\eta$ is a dimensionless coefficient close to unity
