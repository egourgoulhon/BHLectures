...
we may substitute $\w{G}$ in the general formula (\ref{e:evo:mass_variation_gal}) by
$8\pi\w{T}$, where $\w{T}$ is the electromagnetic field's
energy-momentum tensor (\ref{e:fra:T_em}), we get
\end{proof}
