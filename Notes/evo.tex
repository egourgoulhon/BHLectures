...
Any transformation of a black hole with $\delta A > 0$ is called a
...
acheived in the limit case $E_* = \Omega_{\Hor}  L_*$ [cf. Eq.~(\ref{e:evo:dA_Estar_Jstar})].
...
($r = r_+$), which yields $\sqrt{R(r)} = (r_+^2 + a^2) |E_* - \Omega_{\Hor}  L_*| =
...
of $M_{\rm irr}$ in terms of $M$ and $J=aM$ (cf. Fig.~\ref{f:evo:irred_mass}):
...
Suppose some energy is extracted by a Penrose process\index{Penrose!process}
