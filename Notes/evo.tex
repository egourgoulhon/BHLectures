...
\begin{prop}[area increase of accreting Kerr black holes]
...
\ee
with equilatity only for a sequence of reversible transformations.
...
any process (not necessary a small perturbation) such that the null convergence condition
[Eq.~(\ref{e:neh:null_energy_cond})]
is satisfied in the vinicity of the event horizon.
...
some energy is extracted by means of a Penrose process (Property~\ref{p:evo:area_law_Kerr}).
