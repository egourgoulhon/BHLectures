...
find a ``statistical mechanics'' origin for $S_{\rm BH}$, i.e. to interpret $S_{\rm BH}$
as counting some (quantum) microscopic state corresponding to a given macroscopic
...
and loop quantum gravity\index{loop quantum gravity} \cite{Perez17,Rovel04}. Regarding the former, Strominger\index[pers]{Strominger, A.} and Vafa\index[pers]{Vafa, C.} \cite{StromV96} have established
the Bekenstein-Hawking formula (\ref{e:evo:S_BH}) for the entropy in the specific case of
an extremal supersymmetric black hole in dimension $n=5$. By \emph{extremal}\index{extremal!black hole}, it is meant
that the event horizon is a degenerate Killing horizon ($\kappa = 0$, cf. Sec.~\ref{s:neh:classif_KH}), i.e. the Hawking temperature is zero. By \emph{supersymmetric}, it is meant that these black hole
...
recovered by string theory yet.
...
resulted in a statistical entropy propotional to the black hole area,
as for the Bekenstein-Hawking entropy (\ref{e:evo:S_BH}). Subsequent studies
(cf. Refs.~\cite{BarbeP23,Perez17} for reviews) lead to the following
formula for the entropy of a spherically symmetric black hole evaluated
by counting the number of geometric states of the horizon:
\be
    S \simeq \frac{\gamma_0}{\gamma} \frac{A}{4\hbar},
\ee
where $\gamma_0 \simeq 0.274$ and $\gamma$ is the so-called
\emph{Immirzi paramater}\index{Immirzi parameter} (or \emph{Barbero-Immirzi} parameter), whose
value is not set by the theory.
