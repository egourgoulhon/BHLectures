...
The extension of the first law beyond general relativity is performed within a Hamiltonian
framework, which provides the concept of total mass $M$ (``energy'' would be more appropriate),
thereby generalizating the ADM mass to other theories than general relativity.
The Hamiltonian formalism is based on a \emph{phase space}, namely a manifold $\Gamma$,
representing the allowed phases $(q,p)$ and a symplectic form $\omega$ on $\Gamma$.
