...
and the pair $(\mathcal{F},\Omega)$ is called a \defin{symplectic manifold}\defin{symplectic!manifold}\index{manifold!symplectic --}.
Therefore the phase space $\mathcal{F}$ endowed with $\Omega$ is a
symplectic manifold. Not only $\Omega$ is closed, but it is exact. Indeed, it
