...
their \emph{volume}, not with their \emph{area}. This particular feature turned out to have profound
consequences, being at the root of a major paradigm in modern
theoretical physics, namely the \defin{holographic principle}\index{holographic principle}.
This principle, initially devised by Gerard t'Hooft (1993) \cite{tHoof94}
...
is equivalent to a certain string theory in a $(n+1)$-dimensional anti-de Sitter (AdS) spacetime,
the conformal boundary of which is $\M$.
