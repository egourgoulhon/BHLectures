...
applies to Kerr-Newman black holes\index{Kerr-Newman!black hole} and not only to Kerr ones.
In other words, Bekenstein took into account some electric charge, so that he derived
