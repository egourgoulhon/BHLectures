...
consequences, being at the root of the \defin{holographic principle}\index{holographic principle} --- a major concept in contemporary theoretical physics.
...
it asserts that a conformal field theory (CFT) in a $n$-dimensional spacetime $\M$
is equivalent to a certain string theory in a $(n+1)$-dimensional anti-de Sitter\index{anti-de Sitter spacetime} (AdS)\index{AdS} spacetime $\mathscr{B}$, the conformal boundary\footnote{From Example~\ref{x:glo:AdS},
recall that the boundary $\scri$ of the conformal completion of AdS spacetime is a \emph{timelike} hypersurface, i.e. a Lorentzian submanifold, and hence can be considered as a spacetime by itself.}
of which is $\M$.
