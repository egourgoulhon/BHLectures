...
\begin{remark}
The phenomenon of Hawking radiation is essentially kinematics and is independent from any field equation for the
...
$T=0$, i.e. does not detect the Hawking radiation.
\end{remark}
...
$\bar{a} := a/m = J/M^2$:
\be
    T_{\rm H} = \frac{\hbar}{k_{\rm B}} \frac{1}{8\pi M}
