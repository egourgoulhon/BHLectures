...
(\ref{e:neh:null_dominant_cond_T}), but may be obeyed as well in some alternative theories.

Hence, among the three laws, the first one is the most sensitive to
...
could be changed to something else if general relativity is no longer assumed.
