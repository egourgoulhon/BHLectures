...
$\alpha = 2.83\; 10^{-4}$ \cite{ThornZP86,Page76}.
...
$\bar{\nu}_\mu$). It has been updated to the presently known six species, adding
...
\ee
For $\alpha = 2.83\; 10^{-4}$, this yields the numerical value
\be
