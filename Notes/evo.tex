...
We shall assume that $L$ is a function of the metric tensor, the Riemann tensor and a finite number of symmetrized covariant derivatives of the latter:
...
(Einstein-Hilbert action\index{Einstein-Hilbert action}).
