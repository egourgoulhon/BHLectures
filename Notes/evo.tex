...
is restricted to the case where outermost trapped surfaces evolve smoothly, while
their evolution tubes generically have discontinuous jumps, even if the spacetime
and the matter fields remain perfectly smooth,
as we shall discuss in Chap.~\ref{s:loc}. In particular, Kehle and Unger \cite{KehleU23} have exhibited
a spacetime where the collapse of a $C^k$-regular charged scalar field (obeying the dominant, and hence the weak, energy condition) turns a (piece of) Schwarzchild black
