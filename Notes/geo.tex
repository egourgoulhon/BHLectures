...
\begin{tdef}{geodesic}{geo:geodesic}
...
\begin{tprop}{affine parametrizations of a geodesic}{}
...
\begin{tprop}{constancy of the scalar square of affine tangent vector fields}{geo:const_scalar_square}
...
along $\Li$. Hence:
\begin{tprop}{type of geodesics on pseudo-Riemannian manifolds}{}
...
Thus, we have
\begin{tprop}{affine parametrizations with unit tangent vectors}{}
...
\begin{tprop}{generic tangent vector field along a geodesic}{geo:v_pregeodesic}
...
\begin{tdef}{geodesic and pregeodesic vector fields}{}
...
\begin{tprop}{evolution of the scalar square of a tangent vector field}{}
...
\begin{tprop}{proper time and arc length as affine parameters}{geo:proper_time_affine}
...
of a geodesic (Definition~\ref{d:geo:geodesic}).
\end{proof}
...
\begin{tprop}{pregeodesic equation}{}
...
theorem:
\begin{tprop}{existence and uniqueness of geodesic from a vector at a point}{geo:exist_uniq_geod}
...
\begin{tdef}{inextendible geodesic}{}
...
It is easy to show:
\begin{tprop}{inextendibility of complete geodesics}{}
...
More generally:
\begin{tdef}{geodesically complete manifold}{}
...
\begin{tprop}{existence and uniqueness of inextendible geodesic from a vector}{geo:inextend_unique}
...
\begin{tprop}{exponential map as a local diffeomorphism}{geo:exp_diffeo}
...
\begin{tdef}{normal neighborhood}{geo:normal_neighborhood}
...
\begin{tdef}{geodesic normal coordinates}{}
...
$\R^n$:
\begin{tprop}{geodesics in terms of normal coordinates}{}
...
\begin{tprop}{metric components and Christoffel symbols in terms of normal coordinates}{}
...
Hence we conclude:
\begin{tprop}{timelike and spacelike geodesics as stationary points of the length}{}
...
\begin{tprop}{timelike geodesics as curves of maximal length}{geo:timelike_geod_max_length}
Let $(\M,\w{g})$ be a Lorentzian manifold, $p\in\M$ and $\mathscr{U}$ some
normal neighborhood of $p$ (cf. Definition~\ref{d:geo:normal_neighborhood}). For any point $q\in\mathscr{U}$
...
\begin{texample}{timelike geodesic in Minkowski spacetime}{geo:timelike_geod_Mink}
...
\begin{texample}{spacelike geodesic in Minkowski spacetime}{}
...
We conclude:
\begin{tprop}{geodesics as stationary points of the action (\ref{e:geo:energy_funct})}{}
...
\begin{tprop}{constancy of the scalar product of an affine tangent vector
with a Killing vector}{geo:g_xi_v_const}
...
\begin{tdef}{Killing tensor}{}
A \defin{Killing tensor}\index{Killing!tensor}\footnote{also called a
\defin{Stäckel-Killing tensor}\index{Stäckel-Killing tensor} \cite{Carte73a}; cf. the historical note below.}
...
\begin{texample}{various Killing tensors}{geo:trivial_Killing_tensors}
...
neither formed from $\w{g}$ nor any Killing vector $\w{\xi}$ as in Example~\ref{x:geo:trivial_Killing_tensors}, one often says that this spacetime has a \defin{hidden symmetry}\index{hidden symmetry}\index{symmetry!hidden --} (see e.g. the review article \cite{FroloKK17} for
...
\begin{tprop}{conserved quantity induced by a Killing tensor along a geodesic}{geo:cons_quant_Killing_tensor}
...
\begin{hist}
The concept of Killing tensor of rank 2 has been introduced by Paul Stäckel in 1895 \cite{Stack1895}, in connection with conserved quantities that are quadratic in the velocities.
\end{hist}
...
\begin{tprop}{geodesic deviation equation}{geo:geod_deviation}
