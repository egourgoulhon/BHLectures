...
$\w{g}$). In the timelike case, the corresponding affine parameter is called the
\defin{proper time}\index{proper!time}\index{time!proper --}, while in the
spacelike case, it is called the \defin{arc length}\index{arc length}.
\end{greybox}
