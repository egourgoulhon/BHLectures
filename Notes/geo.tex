...
\defin{convex normal neighbourhood}\index{convex normal neighbourhood}\index{normal!neighbourhood!convex --}
$\mathscr{U}$ is an open subset of $\M$ that is a normal neighbourhood of each
of its points. It follows that any two points $p$ and $q$ of a convex normal neighbourhood $\mathscr{U}$
