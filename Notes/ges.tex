...
extrema: a mimimum $r_{\rm per}$, for \defin{periastron}\index{periastron} (or \defin{pericenter}\index{pericenter}), and
a maximum
$r_{\rm apo}$, for \defin{apoastron}\index{apoastron}
(or \defin{apocenter}\index{apocenter}) (cf. Figs.~\ref{f:ges:eff_pot_bound} and \ref{f:ges:orbit_e973_l42}). Being extrema of $r(\tau)$,
