...
\be
    \w{u}_{\Obs} = \left( 1 - \frac{2m}{r} \right) ^{-1} \, \w{\xi} ,
\ee
...
\be
    \veps = - \left( 1 - \frac{2m}{r} \right) \w{u}_{\Obs}\cdot\w{u}
        = \Gamma \left( 1 - \frac{2m}{r} \right)  ,
\ee
where $\Gamma = - \w{u}_{\Obs}\cdot\w{u}$ is the Lorentz factor of $\mathscr{P}$
with respect to $\Obs$. We may express $\Gamma$ in terms of the norm $V$ of the
velocity of $\mathscr{P}$ with respect to $\Obs$.
\end{remark}
...
orbits), but this is a mere coincidence.
\end{remark}
