...
the photon subsequently moves away from the black hole for ever. We may call
such a wordline a scattering trajectory.
...
no.~3 in Fig.~\ref{f:ges:eff_pot_null}), the photon escapes to infinity;
