...
\be
  \encadre{ \veps := \frac{E}{\mu} }\qquad\mbox{and}\qquad
  \encadre{ \ell :=  \frac{L}{\mu} }.
\ee
...
$V_{\ell}$ (called hereafter the \defin{effective potential}\index{effective!potential}), the term $1/2 \, (\D r/\D\tau)^2$ being interpreted as
...
\begin{tabular}{c|c|c}
\hline
$m$ & $r_{\rm ISCO} = 6m$ & $\dfrac{\Omega_{\rm ISCO}}{2\pi}$ \\[1ex]
\hline\hline
$15\, M_\odot$ (Cyg X-1) & $133 {\rm\; km}$ & $147 {\rm\; Hz}$  \\[0.5ex]
\hline
$4.3\; 10^6 \, M_\odot$ (Sgr A*) & $38.1\; 10^6 {\rm\; km} = 0.255 {\rm\; au}$ & $5.11\; 10^{-4} {\rm\; Hz}$ \\[0.5ex]
\hline
$6\; 10^9 \, M_\odot$ (M87) & $355 {\rm\; au}$ & $3.66\; 10^{-7} {\rm\; Hz}$  \\[0.5ex]
\hline
\end{tabular}
}
\caption[]{\label{t:ges:freq_ISCO} \footnotesize
Value of the areal radius $r$ at the ISCO and orbital
frequency $\Omega_{\rm ISCO}/(2\pi)$ for masses $m$ of various astrophysical black holes
...
has a well shape in the region $r>2m$ (cf. Fig.~\ref{f:ges:eff_pot_bound})
and the second one that the particle $\mathscr{P}$ is trapped in this well,
making the right-hand of Eq.~(\ref{e:ges:1d_motion_timelike}) negative, so
...
a maximum
$r_{\rm apo}$, for \defin{apocenter}\index{apocenter} (or \defin{apoastron}\index{apoastron}) (cf. Fig.~\ref{f:ges:eff_pot_bound}). Being extrema of $r(\tau)$,
...
(pericenter) and $r=r_{\rm apo}$ (apocenter).
}
\end{figure}
...
Timelike geodesics with the value of $\ell$ as in Fig.~\ref{f:ges:orbit_e973_l42} ($\ell=4.2m$), but for different values of $\veps$: $\veps = 0.967$ (left) and $\veps=0.990$ (right).
Note that the left and right scales are different.
}
\end{figure}
