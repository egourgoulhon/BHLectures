...
One has then necessarily $\w{\xi}\cdot\w{p} < 0$; hence Eq.~(\ref{e:ges:conserved_energy})
...
(in terms of $r$) for $r_0<2m$: $r$ has to decrease along any future-directed
worldline (cf. Sec.~\ref{s:sch:time_orientation}).
