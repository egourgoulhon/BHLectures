...
\]
This equation can be integrated to (cf. Sec.~\ref{s:sam:ges_radial_free_fall})
...
(left) and in the ingoing Eddington-Finkelstein coordinates $(\tilde{t},r)$ (right),
for various values $r_0$ of the coordinate $r$ at $\tau=0$.}
\end{figure}
