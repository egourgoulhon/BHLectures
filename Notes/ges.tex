...
\defin{marginally bound orbit}\index{marginally bound!orbit}\index{orbit!marginally bound --}\index{marginally bound!geodesic}. Note that the marginally bound orbit is unstable, since it has $r<6m$.
