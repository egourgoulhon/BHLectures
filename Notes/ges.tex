...
($\Li$ timelike) or massless ($\Li$ null).
...
The integral in right-hand side is expressible in terms of the so-called \emph{incomplete integrals
...
case $r=6m$ is called the \defin{innermost stable circular orbit}\index{stable!circular orbit}, often abridged as \defin{ISCO}\index{ISCO}.
\end{greybox}
...
he concluded incorrectly that ``a moving particle outside sphere $r=2m$ can
...
from which no particle may escape, but as an object in which no particle
may penetrate...
