...
$b = b_{\rm crit} = 3\sqrt{3} \, m$; the blue curve is for $r>3m$
...
Trace in the equatorial plane of a
null geodesic in the region $r>3m$ with an impact parameter
equal to the critical one: $b = 3\sqrt{3} \, m \simeq 5.196 m$ and $\ph_\infty=0$.
It obeys Eq.~(\ref{e:ges:null_r_phi_tanh}) with $\ph_0 = -\ph_*$.}
\end{figure}
...
$u>1/3$ ($\iff r< 3m$), which implies $x\in (1,+\infty)$ in Eq.~(\ref{e:ges:primitive_crit_geod}).
...
curve in Fig.~\ref{f:ges:null_r_phi_bcrit}.
