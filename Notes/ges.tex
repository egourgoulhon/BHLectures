...
a stellar black hole (Cyg X-1) \cite{Orosz_al11,Gou_al14}, the black hole at the center of our galaxy
(Sgr A*) \cite{GenzeEG10} and the massive black hole in the nucleus of the galaxy
M87 \cite{Gebha_al11}.}
\end{table}
...
Orbital frequency of the ISCO, $\Omega_{\rm ISCO}/(2\pi)$, for
 masses $m$ corresponding to various astrophysical black holes
...
which more relevant from an observational point of view) are provided in
