...
Effective potential $V_{\ell}(r)$ for $\ell = 4.2 m$.
...
Let us relax the assumption of circular orbit and consider generic orbits
obeying
\be
    | \ell | < \ell_{\rm crit} \qquad\mbox{and}\qquad
      0 < \veps < 1 .
\ee
The first condition ensures that the effective potential
