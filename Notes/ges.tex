...
\begin{tprop}{conserved quantities along causal geodesics}{}
...
\begin{tprop}{positivity of the conserved energy}{ges:E_positive_M_I}
...
By Eq.~(\ref{e:fra:orient_time1}) in Lemma~\ref{p:fra:lem1}, one has then necessarily $\w{\xi}\cdot\w{p} < 0$; hence Eq.~(\ref{e:ges:conserved_energy})
...
\ee
We conclude:
\begin{tprop}{planar character of geodesics}{ges:planar_motion}
...
that
\begin{tprop}{monotonic behavior of $\ph$ along geodesics}{}
...
According to Eq.~(\ref{e:fra:orient_time1}) in Lemma~\ref{p:fra:lem1},
we have then
...
\begin{tprop}{decreasing of $r$ in the black hole region}{}
...
famous \emph{geodesic equation}\index{geodesic!equation}, i.e.
...
Consequently,
\begin{tprop}{$\ph$ as a parameter along geodesics}{}
...
\begin{tprop}{positivity of the specific conserved energy}{}
...
The solution for the radial free fall starting from rest at $r=r_0$ is
...
\be \label{e:ges:veps_ISCO}
    \encadre{ \mathrm{min}\,  \veps = \veps_{\rm ISCO} = \frac{2\sqrt{2}}{3} \simeq 0.9428} .
\ee
...
\begin{tprop}{angular velocity measured at infinity}{}
...
by the orbiting observer/particle $T_{\mathscr{P},\rm ISCO}$ (proper time).}
\end{table}
...
orbital plane, have been first given by Karl Schwarzschild\index[pers]{Schwarzschild, K.}
...
Einstein\index[pers]{Einstein, A.}.
...
Johannes Droste\index[pers]{Droste, J.}, in the same article \cite{Drost1917} in which
...
by Carlo De Jans\index[pers]{De Jans, C.} in 1923 \cite{DeJan1923} and other one by
Yusuke Hagihara\index[pers]{Hagihara, Y.} in 1931 \cite{Hagih1931}.
