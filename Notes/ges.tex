...
plotted in Fig.~\ref{f:ges:eff_pot_timelike}. Its extrema are given by
...
coincide and correspond to an inflection point of $V_{\rm eff}$ (the circle
point in Fig.~\ref{f:ges:eff_pot_timelike}).

For $|\bar{\ell}| < \bar{\ell}_{\rm crit}$, there is no extremum and
$V_{\rm eff}$ is a scritly increasing function of $r$.

\begin{figure}
\centerline{\includegraphics[width=0.8\textwidth]{ges_eff_pot_timelike.pdf}}
\caption[]{\label{f:ges:eff_pot_timelike} \footnotesize
Effective potential ruling the radial motion along a geodesic in
Schwarzschild spacetime.}
\end{figure}

\subsection{Radial trajectories}
