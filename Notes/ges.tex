...
\be
    \w{p} \stackrel{t=0}{=} p^t \wpar_t + p^r \wpar_r + p^\ph \wpar_\ph .
\ee
Now, if for $t>0$, the geodesic $\Li$ would depart from $\th=\pi/2$, this
would constitute some breaking of the spherical symmetry, making a difference
