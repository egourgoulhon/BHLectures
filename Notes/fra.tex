...
Two useful properties are immediate consequences of the above lemma,
...
along $\Li_{\Obs}$ (see e.g. Chap.~3 of Ref.~\cite{Gourg13} for an extended
discussion).
The vector $\w{e}_0$ is then the 4-velocity of observer $\Obs$
and the vectors $(\w{e}_1, \w{e}_2, \w{e}_0)$ form an orthonormal basis
