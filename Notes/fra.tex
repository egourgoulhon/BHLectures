...
\defin{vacuum Einstein equation}\index{Einstein!vacuum -- equation}\index{vacuum!Einstein equation}:
...
\ee
Moreover, $\w{F}$ is governed by the \defin{Maxwell equations}\index{Maxwell equations}:
...
and $\w{j}$ is the \defin{electric current density}\index{electric!current density} vector field,
...
The \defin{electrovacuum Einstein equation}\index{electrovacuum Einstein equation}\index{Einstein!equation!electrovacuum --} is the Einstein equation (\ref{e:fra:Einstein_eq})
