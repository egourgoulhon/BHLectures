...
to $\Hor$. Since $\wl$ is null, it follows then from the lemma
of Sec.~\ref{s:fra:spacetime} that $\w{v}$ cannot be timelike.
\end{proof}
Let $p \in \Sp$ and $\w{v}\in T_p\M$ be a nonzero vector tangent to $\Sp$.
The above propery implies that $\w{v}$ is either spacelike or tangent to the
