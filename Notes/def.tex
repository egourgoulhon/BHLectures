...
\begin{lemma}[vectors tangent to a null hypersurface]
...
to $\Hor$. Since $\wl$ is null, it follows then from Proposition~\ref{p:fra:corol1}
in Sec.~\ref{s:fra:time_orientation} that $\w{v}$ cannot be timelike.
Besides, if $\w{v}$ is null, Proposition~\ref{p:fra:corol2} in Sec.~\ref{s:fra:time_orientation}
