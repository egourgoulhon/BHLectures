...
region of spacetime, we shall assume that the cross-sections have the topology of a sphere,
more precisely the $(n-2)$-dimensional sphere $\mathbb{S}^{n-2}$, where $n$
is the spacetime dimension. Given the definition of a cross-section,
...
On the other side, the future sheet $\Hor$ of the light cone of Minkowkski spacetime considered in Examples~\ref{x:def:light_cone},
...
Schwarzschild horizon considered in Examples~\ref{x:def:Schw_hor}, \ref{x:def:Schw_hor2},
