...
$t$ is a natural parameter along the curve (cf. Fig.~\ref{f:def:orbit_group}). The tangent vector corresponding to that parameter is called the \defin{generator of the symmetry group} $G$
