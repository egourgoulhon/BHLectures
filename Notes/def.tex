...
\]
It is quite natural to assume that matter and non-gravitational fields,
represented by the total energy-momentum tensor $\w{T}$, obey to the
...
\begin{itemize}
\item vacuum: $\w{T}=0$;
\item any ``reasonable'' matter model;
