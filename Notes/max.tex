...
Schwarzschild-Droste coordinates is more complicated than the Kruskal-Szekeres one: Synge coordinates are
...
Let us introduce on $\mathcal{S}_t$ a coordinate system $(x^i)=(\bar{r},\th,\ph)$
as follows:
\begin{subequations}
\begin{align}
\mbox{on}\ \M_{\rm I}:&\quad  \bar{r} \in \left(\frac{m}{2}, +\infty \right),
    \quad r = \bar{r} \left( 1 + \frac{m}{2\bar{r}} \right)^2
    \iff \bar{r} = \frac{1}{2} \left( r - m + \sqrt{r (r-2m)} \right) \\
\mbox{on}\ \M_{\rm III}:&\quad  \bar{r} \in \left(0, \frac{m}{2} \right),
   \quad r' = \bar{r} \left( 1 + \frac{m}{2\bar{r}} \right)^2
    \iff \bar{r} = \frac{1}{2} \left( r' - m - \sqrt{r' (r'-2m)} \right)
\end{align}
\end{subequations}
