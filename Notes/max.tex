...
\emph{Kruskal diagram}\index{Kruskal!diagram}, cf. Fig.~\ref{f:sch:kruskal_diag}) has been first presented by
...
It is known as \defin{Flamm paraboloid}\index{Flamm paraboloid} \cite{Flamm1916} and is depicted in Fig.~\ref{f:max:flamm_paraboloid}.
...
Flamm paraboloid: isometric embedding of a slice $T=0$ and $\th=\pi/2$
of Schwarzschild spacetime in the Euclidean 3-space.}
\end{figure}

\begin{figure}
\begin{tabular}{ccccc}
\includegraphics[width=0.18\textwidth]{max_flamm_paraboloid.png} &
\includegraphics[width=0.18\textwidth]{max_embedding_T0_05.png} &
\includegraphics[width=0.18\textwidth]{max_embedding_T0_10.png} &
\includegraphics[width=0.18\textwidth]{max_embedding_T0_15.png} &
\includegraphics[width=0.18\textwidth]{max_embedding_T0_20.png} \\
$T_0=0$ & $T_0=0.5$ & $T_0=1$ & $T_0=1.5$ & $T_0=2$
\end{tabular}
\caption[]{\label{f:max:embeddings} \footnotesize
Sequence of isometric embeddings.}
\end{figure}
