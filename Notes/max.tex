...
We deduce from (\ref{e:sch:metric_UV}) that the components
$g^{UU}$ and $g^{VV}$ of the inverse metric $\w{g}^{-1}$ vanish identically.
It follows that both $U$ and $V$ are null coordinates
(cf. the criterion~(\ref{e:bas:char_causal_type_coord})).
