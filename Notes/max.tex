...
$R(r) := 2m \left[ \mathrm{arcosh}\sqrt{\frac{r}{2m}} + \sqrt{ \frac{r}{2m}\left(\frac{r}{2m} - 1 \right) }\right]$; compare with (\ref{e:sch:KS_SD_I}).
...
process of gravitational collapse\index{gravitational!collapse}\index{collapse!gravitational --} yields a spacetime
...
exterior contains parts of regions $\M_{\rm I}$, $\M_{\rm II}$ and $\M_{\rm IV}$, and even $\M_{\rm III}$ (in which case, it is called a \emph{semiclosed world}\index{semiclosed world}) \cite{Novik63} (see also Sec.~2.7.2 of Frolov \& Novikov's textbook \cite{FroloN98}).
