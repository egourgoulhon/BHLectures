...
\be \label{e:max:scri_hUhV}
    \scri^+:\ \hat{V}\rightarrow \frac{\pi}{2} \qquad\mbox{and}\qquad
    \scri^-:\ \hat{U}\rightarrow -\frac{\pi}{2}.
\ee

By symmetry, the extension $\M_{\rm III}\cup \M_{\rm IV}$ of Schwarzschild
spacetime has the following null infinity:
\be \label{e:max:scri_prime_hUhV}
    {\scri'}^+:\ \hat{U}\rightarrow \frac{\pi}{2} \qquad\mbox{and}\qquad
    {\scri'}^-:\ \hat{V}\rightarrow -\frac{\pi}{2}.
\ee
