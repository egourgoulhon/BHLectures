...
Function $F:\; x\mapsto \mathrm{e}^{x}(x-1)$, giving
...
(i.e. the part $\tilde{X}>\pi/2$) looks very much the same than that of
Minkowski conformal diagram.
However, there is a difference: the coordinates $(\tilde{T},\tilde{X})$
employed in the construction of the diagram of
Fig.~\ref{f:sch:sch_carter-penrose} are not related to a regular conformal
completion, as defined in Sec.~\ref{s:glo:conf_compl}. To see this, let us
