...
$(\M,\w{g})$ say, which on its side cannot be extended, i.e. is maximal.
...
with a slope of $+1$ for the outgoing family and $-1$ for the ingoing one.
...
acheives this goal.
Finally, in Sec.~\ref{s:max:ER_bridge}, we insestigate the hypersurfaces of
...
\section{Physical properties of the maximal extension}

\subsection{Naked singularity}

Beside containing a white hole (cf. Sec.~\ref{s:max:black_white}),
the maximal extension of Schwarzschild spacetime
contains a \defin{naked singularity}\index{naked singularity}\index{singularity!naked}
from the point of view of observers in the external region $\M_{\rm I}$ or $\M_{\rm III}$,
namely a curvature singulary that can be seen by such observers. Indeed, it is clear from
...
In a given spacetime, a naked singularity is viewed as a limitation to predictability, since one cannot compute what will come out of the singularity. That no ``reasonable'' physical process
can generate a naked singularity is known as the \emph{weak cosmic censorship conjecture}\index{cosmic censorship!weak --}\index{weak!cosmic censorship}, first
...
We shall see in Chaps.~\ref{s:lem} and \ref{s:vai} that black hole formation by the standard
process of gravitational collapse yields, in spherical symmetry, a spacetime
that contains some parts of the regions $\M_{\rm I}$ (the black hole exterior)
and $\M_{\rm II}$ (the black hole interior) of Schwarzschild spacetime, but that do not contain
...
cannot be formed by the gravitational collapse of a star or a cloud of matter.
