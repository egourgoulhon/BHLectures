...
future, such that, at each point $p\in\Sp$, $(\w{n},\w{s})$ is an orthonormal basis
...
In way similar to the construction of the Komar mass from a timelike Killing
vector, an axisymmetry Killing vector gives birth an invariant integral quantity:
...
\ee
where $\Sp$ is any spacelike surface lying in the vacuum region. As the Komar
mass, $J$ does not depend on the choice of $\Sp$, provided it lies in the
vacuum region and $\w{g}$ obeys Einstein equation.
