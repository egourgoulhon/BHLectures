...
in Sec.~\ref{s:ker:principal_geod} below), when the principal null congruence has
a non-vanishing twist. The case of vanishing twist (i.e. hypersurface-orthogonal
...
Kerr coordinates are actually those in which Roy P.~Kerr\index{Kerr, R.P.} originally presented his
...
of the 2-dimensional manifold constituting the symmetry axis $\theta=0$ or $\pi$ of Kerr spacetime, leading to a diagram similar to that of Fig.~\ref{f:ker:max_ext} (Fig.~1 of Ref.~\cite{Carte66}). In the same article, Carter suggested that the maximal analytic extension of the whole 4-dimensional
manifold would be similar. This was proved rigorously a year later by
...
possibly\footnote{In Fig.~\ref{f:ker:cauchy_hor}, $\Sigma$ runs through the bifurcation
surface between $\M_{\rm I}$ and ${\M'}_{\rm I}$, but this is not mandatory.} through $\M_{\rm II}$ or ${\M_{\rm II}}^*$ (cf. Fig.~\ref{f:ker:cauchy_hor})
