...
The Boyer-Lindquist coordinates have been introduced in 1966 by Robert H.~Boyer\index[pers]{Boyer, R.H.} (see the historical note on page~\pageref{h:sta:Boyer}) and Richard W. Lindquist\index{Lindquist, R.W.} \cite{BoyerL67} (compare Eq.~(2.13) of Ref.~\cite{BoyerL67} with
...
considered by Robert H.~Boyer\index[pers]{Boyer, R.H.} and Richard W. Lindquist\index{Lindquist, R.W.}
...
Robert H. Boyer\index[pers]{Boyer, R.H.} and Richard W. Lindquist\index{Lindquist, R.W.} \cite{BoyerL67}
