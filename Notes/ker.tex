...
the dotted curves marks the hypersurfaces $r=\mathrm{const}$.}
\end{figure}
...
$r=\mathrm{const}$. From their inclination, we recover clearly the results
...
denoted by $v=v_0$ is bounded from above by $-r_+$. Actually the
situation is completely symmetric to that of the original Kerr
spacetime depicted in Fig.~\ref{f:ker:3blocks_in}. In particular,
...
of a white hole). The hypersurface $r=r_+$ is the corresponding
...
the various blocks. We shall not
