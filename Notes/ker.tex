...
With this in mind, we shall call a \defin{Carter-Penrose diagram}\index{Carter-Penrose diagram}
...
of $\w{\xi}$, i.e. the orbits of the stationary group action.
...
axis\footnote{The rotation axis\index{rotation!axis} is the 2-dimensional Lorentzian
submanifold $\mathscr{A}$ where the Killing vector $\w{\eta}$ vanishes
(cf. the definition given in Sec.~\ref{s:sta:strong_rigidity});
in terms of the 3+1 Kerr coordinates $(\ti, r, \th, \tph)$, $\mathscr{A}$ is defined by
by $\th=0$ or $\pi$ and is naturally spanned by the coordinates
$(\ti, r)$. In Ref.~\cite{Carte66}, Carter has shown that the metric induced by $\w{g}$
onto $\mathscr{A}$ is locally conformal to the metric of a 2-dimensional Minkowski spacetime
and used this to represent $\mathscr{A}$ by a 2-dimensional conformal diagram.}
of the Kerr spacetime, leading to a diagram similar to that of
Fig.~\ref{f:ker:max_ext} (Fig.~1a of Ref.~\cite{Carte66}). In the same article, Carter suggested that the maximal analytic extension of the whole 4-dimensional
