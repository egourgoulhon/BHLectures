...
\defin{Komar angular momentum}\index{Komar!angular momentum}\index{angular!momentum!Komar --}
by
\be \label{e:ker:def_Komar_J}
    \encadre{ J := \frac{1}{16\pi} \int_{\Sp} \star(\dd \uu{\eta}) } ,
\ee
where $\Sp$ is any closed spacelike 2-surface lying in the vacuum region and $\star(\dd \uu{\eta})$
