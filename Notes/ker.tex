...
\end{remark}
In view of Eq.~(\ref{e:ker:star_duxi}) and the last equality in Eq.~(\ref{e:ker:duxi_nab}),
the Komar mass formula (\ref{e:ker:def_Komar_mass}) becomes
...
\ee
Using the last equality in Eq.~(\ref{e:ker:duxi_nab}), this becomes
\be
    \encadre{ M = -\frac{1}{8\pi} \int_{\Sp} \nabla_\mu \xi_\nu \,  \D S^{\mu\nu} } .
\ee
Alternatively, we may express the exterior derivative in terms of
partial derivatives (first equality in Eq.~(\ref{e:ker:duxi_nab})) and get
\[
    (\dd \uu{\xi})_{\mu\nu} \,  \D S^{\mu\nu} =
    (\partial_\mu \xi_\nu - \partial_\nu \xi_\mu)
...
into the so-called \defin{Smarr formula}\index{Smarr formula}:
\be \label{e:ker:Smarr}
    \encadre{ M =  2 \Omega_H J + \frac{\kappa A}{4\pi} } .
\ee

\begin{hist}
Equation~(\ref{e:ker:Smarr}) has been derived in 1973 by Larry Smarr\index{Smarr, L.}
\cite{Smarr73} in the more general case of the Kerr-Newman black hole\index{Kerr-Newman black hole};
