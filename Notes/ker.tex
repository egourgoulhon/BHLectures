...
A Carter-Penrose diagram of the Kerr spacetime $(\M,\w{g})$ is depicted in
Fig.~\ref{f:ker:3blocks_in}. This diagram could be obtained by means of
``compactified'' coordinates in the $(\ti,r)$ coordinate plane, so that
each point in this diagram is a 2-sphere, spanned by $(\th,\tph)$, except
...
the null curves are represented by $\pm 45$ lines. A difference with the Schwarzschild case
is that the dependence of the Kerr metric on $\theta$ is not represented in
