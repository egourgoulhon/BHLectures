...
The Boyer-Lindquist coordinates have been introduced in 1966 by Robert H.~Boyer\index[pers]{Boyer, R.H.} (see the historical note on p.~\pageref{h:sta:Boyer}) and Richard W. Lindquist\index[pers]{Lindquist, R.W.} \cite{BoyerL67} (compare Eq.~(2.13) of Ref.~\cite{BoyerL67} with
...
\end{prop}
\begin{proof}
The Kretschmann scalar expressed in terms of the Boyer-Lindquist coordinates is (cf. the notebook~\ref{s:sam:Kerr_solution} for the computation)
...
\ee
The inverse metric also takes a rather simple form in terms of the
...
black hole feature, by means of the Kerr coordinates.
...
coordinates on $\Hor$ and $\Hor_{\rm in}$, not any
