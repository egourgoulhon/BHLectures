...
by (\ref{e:ker:metric_BL}), is a solution of Einstein equation (\ref{e:fra:Einstein_eq})
...
and $\th=\pi/2$ of the wordline of a particle and its 4-momentum $\w{p}$,
...
The grey zone is the ergoregion.
}
\end{figure}

The part of the outer ergoregion (cf. Sec.~\ref{s:ker:ergoregion})
that is located outside the event horizon
is actually a region where energy can be extracted ``from''
the black hole. This is due to the fact that the stationarity Killing
vector $\w{\xi}$ is spacelike there --- the very definition of an
ergoregion. Indeed, let us consider a particle $\mathscr{P}$, of 4-momentum $\w{p}$,
arriving from infinity into the ergoregion. At some point $A$ outside the black hole
region, the particle $\mathscr{P}$
decays into two particles: $\mathscr{P}'$, of 4-momentum $\w{p'}$, which leaves to
infinity and $\mathscr{P}''$, of 4-momentum $\w{p''}$, which falls into the black hole.
