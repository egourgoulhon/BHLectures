...
\subsection{Conformal completion of \texorpdfstring{AdS$_4$}{AdS4}}  \label{s:sam:AdS}

This notebook introduces AdS$_4$ in various coordinate systems and provides
the figure of Example~\ref{x:glo:AdS}.\\[1ex]
{\footnotesize
\url{https://nbviewer.jupyter.org/github/sagemanifolds/SageManifolds/blob/master/Notebooks/SM_anti_de_Sitter.ipynb}
}


\subsection{Poincaré horizon in \texorpdfstring{AdS$_4$}{AdS4} as a degenerate Killing horizon} \label{s:sam:Poincare_hor}

This notebook accompanies Example~\ref{x:neh:AdS}.\\[1ex]
{\footnotesize
...
\subsection{Null geodesics in Schwarzschild spacetime with \texorpdfstring{$b<b_{\rm c}$}{b<bc}} \label{s:sam:gis_paramaters_b_lt_bc}
%
...
\subsection{Isometric embbedings of \texorpdfstring{$(t,\th)$}{(t,θ)} sections of the extremal Kerr spacetime} \label{s:sam:Kerr_extremal_throat_emb}
