...
point where they entered $\Hor$, and
...
where neighbouring null geodesics focus and converge while entering $\Hor$.
\end{quote}
In particular, once a null geodesic has
entered $\Hor$ (where it may intersect other null geodesics),
...
Spacetime diagram showing the event horizon and some of its null geodesic generators in a head-on collision of two black holes; the left picture is a zoom of the caustic region
(source: Matzner et al. (1995) \cite{Matzn_al95}).}
\end{figure}
...
of the head-on collision of two black holes by Matzner et al. \cite{Matzn_al95}.
...
where null generators cross each other while entering in $\Hor$.
...
apply the \defin{Israel uniqueness theorem}\index{Israel uniqueness theorem}
 which
