...
presenting the conformal diagram of the maximally extended Schwarzschild spacetime
(Fig.~\ref{f:glo:Schwarz_BH}). Such a conformal diagram will
be constructed rigorously in Sec.~\ref{s:max:Carter-Penrose}.
Note that the Schwarzschild black hole is asymptotically flat, so that
