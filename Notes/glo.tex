...
\begin{example}[Schwarzschild-de Sitter black hole]
\label{x:glo:de_Sitter_BH}
...
\begin{example}[Schwarzschild-anti de Sitter black hole]
\label{x:glo:anti_de_Sitter_BH}
...
\label{x:glo:Schwatz_white_hole}
...
\begin{example}[head-on binary black hole merger]
...
\begin{example}[inspiralling binary black hole merger]
...
\begin{example}[Schwarzschild and Schwarzschild-(anti-)de Sitter horizons]
