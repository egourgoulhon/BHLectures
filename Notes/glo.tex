...
the pale yellow area is $J^-(\scri^+)$ --- the causal past of the future null infinity $\scri^+$,
while the grey area is the black hole region $\mathscr{B}$. Green lines are radial null geodesics and
the orange zig-zag lines denote curvature singularities.}
\end{figure}
...
drawn with a $\pm 45^\circ$ inclination in Fig.~\ref{f:glo:Schwarz_BH}.
\end{example}
