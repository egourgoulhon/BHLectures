...
will be constructed rigorously in Sec.~\ref{s:max:Carter-Penrose}. For the present
...
it is quite natural that the event horizon $\Hor$ is a hypersurface
...
$\Hor$ is not differentiable. Only the continuity of the manifold holds
everywhere, i.e. $\Hor$ is guaranted to be a \emph{topological} manifold, if not
a smooth one:

\begin{prop}[the event horizon as a topological manifold of codimension 1]
\label{p:glo:prop2}
A black hole event horizon $\Hor$ is a topological manifold of dimension $n-1$, $n$ being the spacetime
dimension.
\end{prop}
