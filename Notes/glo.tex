...
with the most extremal edges identified for $\mathcal{N}_{\rm c}<+\infty$ (see Sec.~9.4 of Ref.~\cite{GriffP09} and references therein).} is shown in Fig.~\ref{f:glo:de_Sitter_BH}.
...
\begin{prop}[the event horizon as a manifold of codimension 1]
\label{p:glo:prop2}
