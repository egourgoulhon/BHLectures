...
\section{Preliminary reflections about black holes} \label{s:def:BH_null_hypsurf}
...
in quasi-local approaches to black holes. So both types (null or spacelike) of one-way membranes
...
starting by the conformal completion of the simplest
