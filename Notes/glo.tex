...
boundary\footnote{Cf. Sec.~\ref{s:bas:manif_boundary} for the precision definition.}\index{manifold!with boundary}
...
e.g. black holes in Minkowski space, as explained below.
