...
Let us illustrate the above black hole definition by a few examples, starting
from a trivial one:
...
Then, we turn to three basic examples of spherically symmetric black holes.
...
Here we simply illustrate graphically the definition (\ref{e:glo:def_BH}) by
...
If one releases the assumption of $\scri^+$-completeness in the definition of a black hole
given above,
