...
Proving that, for any $p\in\Hor$, $I^-(p)\subset J^-(\scri^+)$ (left)
...
For any $q\in I^-(p)$, we have by definition $p\in I^+(q)$ (cf. Fig.~\ref{f:glo:topmanif_Ip_Im} left)
...
such a curve (like the purple one in Fig.~\ref{f:glo:topmanif_chart})
