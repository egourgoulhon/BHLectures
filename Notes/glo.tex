...
Furthermore, ones says that $(\tilde{\M},\w{\tilde{g}})$ is a
...
main properties of its boundary, the event horizon.
...
The key thing is that one can ``move the ends'' of any timelike curve
``a little bit'' and still get a timelike curve. In other words, there exists
...
This is more or less evident on a spacetime diagram and a formal proof
...
\subsubsection{Property 3 (Penrose 1968):}
\begin{quote}
$\Hor$ is generated by a familly of null geodesics that (i) may leave $\Hor$
in the past, but never in the future, and (ii) have no endpoint in the future.
\end{quote}
