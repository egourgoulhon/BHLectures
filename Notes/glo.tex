...
the grey area is the black hole region $\mathscr{B}$.}
\end{figure}
...
from various values of $\Lambda$, cf. Property~\ref{p:glo:type_scri_sign_Lambda}):
...
purpose, it is sufficient to tell that it
