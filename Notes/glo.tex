...
with the most extremal edges identified for $\mathcal{N}_{\rm c}<+\infty$ (see Refs.~\cite{GibboH77,Geyer80} or Sec.~9.4 of Ref.~\cite{GriffP09}).} is shown in Fig.~\ref{f:glo:de_Sitter_BH}.
...
(see Refs.~\cite{LakeR77} and \cite{FidkoHKS04} for the construction of this diagram).
