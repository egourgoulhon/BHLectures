...
have been shown to be spacelike (cf. Example~\ref{x:glo:dS4} on p.~\pageref{x:glo:dS4}).
...
is a timelike hypersurface of $(\tilde{\M},\w{\tilde{g}})$, as shown in Example~\ref{x:glo:AdS} (Sec.~\ref{s:glo:def_conf_compl}).
...
Example~\ref{x:loc:Bardeen_BH} of Chap.~\ref{s:loc}.
\end{remark}
...
\begin{tprop}{the event horizon ruled by never leaving null geodesics \textnormal{(Penrose\index[pers]{Penrose, R.} 1968 \cite{Penro68})}}{glo:prop3}
