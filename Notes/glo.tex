...
and some reflexions about what the black hole boundary could be (Sec.~\ref{s:def:BH_null_hypsurf}).
We shall then coinvince ourselves that a rigourous definition of a black hole
requires to take into account the global structure of spacetime, in particular its
...
before considering the conformal completion of general spacetimes (Sec.~\ref{s:glo:conf_compl}).
This will allow us to express the rigorous definition of a black hole
and to study the main properties that directly follow from it
(Sec.~\ref{s:glo:BH}), independently of any gravity theory.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Preliminary reflexions about black holes} \label{s:def:BH_null_hypsurf}
...
spacetime is such a region. It is true then any particle moving inside it is
...
shares the same properties as the conformal diagrams of Minkowkski spacetime
...
The extended Schwarzschild spacetime has two (causaly disconnected) regions where $2m < r < +\infty$,
...
such that the hypersurfaces $r=r_{\rm h}$ or $r=r_{\rm c}$ are null. According to the criterium~(\ref{e:bas:char_null_coord}),
...
the contant-$r$ hypersurfaces are null, being the only positive zero of
...
$\M_{\rm III}$, in which $2m < r < +\infty$, are both asympotically flat.
