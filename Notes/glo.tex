...
with the most extremal edges identified for $\mathcal{N}_{\rm c}<+\infty$ (see Ref.~\cite{GibboH77} or Sec.~9.4 of Ref.~\cite{GriffP09}).} is shown in Fig.~\ref{f:glo:de_Sitter_BH}.
...
green lines are radial null geodesics and
the orange zig-zag lines at $r=0$ denote curvature singularities.}
\end{figure}
...
(see Refs.~\cite{LakeR77} and \cite{GriffP09} for the construction of this diagram).
