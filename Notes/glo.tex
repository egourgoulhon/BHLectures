...
of the vacuum Einstein equation\index{Einstein!vacuum -- equation}\index{vacuum!Einstein equation} (\ref{e:fra:vac_Einstein_Lambda}) with
...
\begin{prop}[the event horizon ruled by never leaving null geodesics \textnormal{(Penrose\index{Penrose, R.} 1968 \cite{Penro68})}]
\label{p:glo:prop3}
