...
are null hypersurfaces of $(\tilde{\M},\tilde{\w{g}})$ and therefore
...
For large values of the areal radius $r$, the spacetime approaches the anti-de Sitter spacetime\index{anti-de Sitter spacetime}, for which $\scri^+$ and $\scri^-$
