...
\begin{figure}
\centerline{\includegraphics[width=0.7\textwidth]{glo_CP_Schwarz_BH.pdf}}
\caption[]{\label{f:glo:CP_Schwarz_BH} \footnotesize
Carter-Penrose diagram of the maximal extension of Schwarzschild spacetime;
...
(Fig.~\ref{f:glo:CP_Schwarz_BH}). Such a conformal diagram will
be constructed rigorously in Sec.~\ref{s:max:Carter-Penrose}.
\end{example}


\begin{figure}
\centerline{\includegraphics[width=0.7\textwidth]{glo_CP_de_Sitter_BH.pdf}}
\caption[]{\label{f:glo:CP_de_Sitter_BH} \footnotesize
Carter-Penrose diagram of the Schwarzschild-de Sitter spacetime; the grey
area is the black hole region $\mathscr{B}$.}
\end{figure}

\begin{example}[Schwarzschild-de Sitter black hole]
The Schwarzschild spacetime has a null future infinty $\scri^+$.
...
cf. Fig.~\ref{f:glo:CP_de_Sitter_BH}.
\end{example}
