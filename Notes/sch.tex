...
future and all of them terminates at $r=0$. They are thus incomplete geodesics.

On the other hand the outgoing radial null geodesics are limited by
the constraint $T+X > 0$, which corresponds to $r>2m$ in $\M_{\rm I}$ and
$r<2m$ in $\M_{\rm II}$.
