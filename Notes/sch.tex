...
\subsection{The Schwarzschild-Droste domain}
...
\begin{remark}
Strictly speaking, we found radial null curves only and since not all null curves
are geodesics, there remains to check that the curves satisfy the geodesic
equation.
\end{remark}
