...
nearby timelike geodesics (tidal force) is governed by the Riemann tensor,
via the so-called \emph{geodesic deviation equation}\index{geodesic!deviation equation}
(see e.g. Chap.~11 of MTW \cite{MisneTW73}).
