...
However, we have $g_{rr} = 1+2m/r > 0$ everywhere, so that $r$ remains a spacelike coordinate (for the IEF system) in
...
\be \label{e:sch:Kerr_Schild}
  g_{\tilde{\mu}\tilde{\nu}}\, \D x^{\tilde{\mu}} \, \D x^{\tilde{\nu}} =
 \underbrace{- \D\ti^2 + \D r^2 + r^2  \left( \D\th^2 + \sin^2\th\,
   \D\ph^2 \right)}_{f_{\tilde{\mu}\tilde{\nu}} \, \D x^{\tilde{\mu}} \, \D x^{\tilde{\nu}}}
        + \underbrace{\frac{2m}{r} \left( \D\ti + \D r \right) ^2}_{k_{\tilde{\mu}} \D x^{\tilde{\mu}} \, k_{\tilde{\nu}} \D x^{\tilde{\nu}}} ,
\ee
where the $f_{\tilde{\mu}\tilde{\nu}}$'s are the components of the (flat) Minkowski metric expressed in
terms of the spherical coordinates $(\ti,r,\th,\ph)$ and the $k_{\tilde{\mu}}$'s are
