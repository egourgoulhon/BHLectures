...
a past-directed null geodesic: a generic point of $\scri'$ has coordinates
$(v,x,\th,\ph) = (v_0,1,\th_0,\ph_0)$ and is the past end point of the
ingoing radial null geodesics defined by
$(v,\th,\ph) = (v_0,\th_0,\ph_0)$.
...
\ee
The boundary of $\M''_{\rm I}$, $\scri''$ say, lies at $x=1$. It shall not be
