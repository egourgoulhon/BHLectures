...
\begin{remark}
In $\M_{\rm II}$, the four coordinates $(\ti,r,\th,\ph)$ are spacelike, i.e.
the four vectors $(\wpar_{\ti},\wpar_{\tilde{r}}, \wpar_\th, \wpar_\ph)$
are spacelike. There is nothing wrong about that: this does not
...
a diagonal form, which is not the case here, since
$g_{\ti r} \neq 0$ [Eq.~(\ref{e:sch:Schwarz_metric_EF})].
All that is demanded
to $(\ti,r,\th,\ph)$ to be (locally) a regular coordinate system is that
