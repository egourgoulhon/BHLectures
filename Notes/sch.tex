...
and that of the second term from Eq.~(\ref{e:fra:orient_time1})
in Lemma~1 of Sec.~\ref{s:fra:time_orientation} applied to the
future-directed timelike vector $-\wpar_r$ and to the future-directed
null or timelike vector $\w{v}$.
