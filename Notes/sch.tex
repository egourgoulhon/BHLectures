...
that $g_{tt} > 0$ and $g_{rr} < 0$
i.e. the vector field $\wpar_t$ is spacelike, while $\wpar_r$ is timelike.
This means that $(\M_{\rm II},\w{g})$ is not static, as defined in
Sec.~\ref{s:sch:static_spher}.
