...
where $r\to 0$.
Hence the ``point'' $(t,r) = (v,r) = (0,0)$ of Vaidya spacetime in IEF coordinates
becomes the hypersurface $v = 0$, $u > 0$ in the double-null coordinates.

\begin{example}
Let us perform a first order expansion in $v$ of the explicit expression of $r(u,v)$
found in Example~\ref{x:vai:u_r_1o9} [Eq.~(\ref{e:vai:r_uv_1o9})]. We
get
\be
\begin{cases}
...
\end{cases}
\ee
The last equation agrees fully with (\ref{e:vai:r_v_0_N_I}) since $x_2=6$
for this example.
\end{example}
