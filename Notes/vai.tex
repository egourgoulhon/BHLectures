...
\defin{future outer trapping horizon}\index{future!outer trapping horizon}\index{trapping horizon!future!outer --}. It obeys the following properties.
...
[Eq.~(\ref{e:vai:def_T}) with $M(v) = \alpha v / 2$], so that the equation
...
and making use of expression (\ref{e:vai:thin:u_H}):
\be
