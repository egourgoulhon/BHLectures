...
On $\mathscr{N}_{\rm I}$, we introduce the parameter $u$ so that
\be
...
instead of IEF coordinates $(t, r, \th, \ph)$. Note that the
homothetic Killing horizon $\Hor_1$, which is defined by $v/r = x_1$,
is the hypersurface $u = 0$.
The metric components in the coordinates $(u, v, \th, \ph)$
are deduced from those in the $(v, r, \th, \ph)$
coordinates, i.e. Eq.~(\ref{e:vai:self_similar_metric}). We get
