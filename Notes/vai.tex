...
$\mathcal{N}_{\rm II}$ (left) of the radiation region. Zigzag lines indicate
...
It is depicted in Fig.~\ref{f:vai:CPdiag_NI_NII}.
...
\ee
The black hole event horizon $\Hor$ intersects $\M_{\rm rad}$ in
$\mathcal{N}_{\rm II}$, given that $x_A = \alpha^{-1} >  x_1$.
Since $\Hor$ is generated by outgoing radial
null geodesics, $\Hor\cup \M_{\rm rad}$ lies a constant value of $u'$, which
