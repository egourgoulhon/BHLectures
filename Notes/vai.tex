...
\begin{hist}
The infalling shell model (\ref{e:vai:mass_function})
...
Both studies regarded the specific case $S(x) = x$. Hiscok et al. considered
...
\begin{hist}
The infalling radiation shell with $M(v)$ piecewise linear has been extensively
studied by Achilles Papapetrou\index{Papapetrou, A.} in 1985 \cite{Papap85}.
He derived the solution (\ref{e:vai:eq_out_v0_small}) for the outgoing radial
null geodesics and made an analysis of the event horizon similar to
