...
\begin{tprop}{null hypersurfaces $\bm{v = \mathrm{const}}$ and their normals}{vai:null_hyp_v_const}
...
\begin{tprop}{time orientation of spacetime}{}
...
A consequence is
\begin{tprop}{Vaidya metric as a solution to the Einstein equation}{}
The ingoing Vaidya metric (\ref{e:vai:Vaidya_metric_null}) is a solution
to the Einstein equation (\ref{e:fra:Einstein_eq})
...
Schwarzschild metric is a solution to the vacuum Einstein equation.
\end{remark}
...
\begin{tprop}{Vaidya metric sourced by electromagnetic radiation}{vai:source_Vaidya_metric}
...
\begin{tprop}{radial null geodesics}{}
...
\subsection{Solution for \texorpdfstring{$M(v)$}{M(v)} piecewise linear} \label{s:vai:sol_M_linear}
...
\begin{tprop}{outgoing radial null geodesics for the $\bm{\alpha > 1/8}$ homothetic shell}{}
...
\begin{tprop}{black hole formation for the $\bm{\alpha > 1/8}$ homothetic shell}{}
...
\begin{tprop}{black hole formation in the Minkowski region}{}
...
In other words:
\begin{tprop}{curvature singularity in Vaidya shell collapse}{}
...
\begin{tprop}{trapped surfaces in Vaidya shell collapse}{vai:trapped_surfaces}
...
hence we get
\begin{tprop}{trapping horizon and $r$-turning points of radial null geodesics}{}
...
\begin{tprop}{causal type of the future outer trapping horizon}{}
...
\begin{texample}{future outer trapping horizon for the homothetic shell model with $v_0 = 3m$}{}
...
$\w{g}(\wpar_u,\wpar_v) = g_{uv} < 0$, so that, according to Lemma~\ref{p:fra:lem2}, $\wpar_v$ is future-directed as well.
...
\begin{tprop}{homothetic Killing horizons}{}
...
\begin{texample}{}{vai:sol_out_1o9}
...
\begin{tprop}{black hole and naked singularity for the $\bm{\alpha<1/8}$ model}{}
The homothetic imploding radiation shell with $\alpha := 2m/v_0 < 1/8$
...
\begin{texample}{$r$ in terms of $(u,v)$ for $\alpha=1/9$}{vai:u_r_1o9}
...
$v \to 0$. We conclude:
\begin{tprop}{curvature singularity in region $\bm{\mathscr{N}_{\rm I}}$}{}
...
\begin{texample}{$r$ in terms of $(u', v)$ for $\alpha=1/9$}{}
...
\begin{tprop}{curvature singularity in region $\bm{\mathscr{N}_{\rm II}}$}{}
