...
\be \label{e:vai:mass_function}
    M(v) = \left\{ \begin{array}{ll}
     ...
     \mbox{increasing from}\ 0 \ \mbox{to}\ m \quad \mbox{for} \ 0 \leq v \leq v_0
...
\begin{figure}
\centerline{\includegraphics[width=0.6\textwidth]{vai_diagram.pdf}}
\caption[]{\label{f:vai:diagram} \footnotesize
Spacetime diagram of the Vaidya collapse based on the IEF coordinates $(t, r)$
and for the mass function $M(v)$ shown in Fig.~\ref{f:vai:mass_function}.
...
\ee
Except for $M$ being a constant function, this ODE can be solved only numerically.
The result is shown in Fig.~\ref{f:vai:diagram} for the function $M$
of Fig.~\ref{f:vai:mass_function} (green curves).
...
as soon as $r < 2 M(t+r)$. This corresponds to the region bounded by the red curve in Fig.~\ref{f:vai:diagram}.
\end{remark}
...
It appears clearly on Fig.~\ref{f:vai:diagram} that the outgoing
