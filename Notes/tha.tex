...
\defin{presymplectic current $(n-1)$-form}\index{presymplectic!current form} \cite{WaldZ00}.
...
The presymplectic current $(n-1)$-form $\w{\omega}$ is closed:
...
we are considering only families of solutions of the field equations. Hence
