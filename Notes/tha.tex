...
the differential form $\w{J}\lld\w{\xi}\rld$ is closed as soon as the equations of motion (\ref{e:tha:eom_E}) are fulfilled  or $\w{\xi}$ is a Killing vector:
...
Let us show that the corresponding Noether charge $(n-2)$-form is nothing but minus the Hodge dual of the exterior derivative
