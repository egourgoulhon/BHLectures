...
and we have then $\delta H_{\w{\xi}} = \langle \Dd H_{\w{\xi}}, \delta\w{g} \rangle$,
so that Eq.~(\ref{e:tha:delta_H_xi}) is equivalent to
...
vector field $X_H$ in terms of the Hamiltonian $H$. The difference is that $\Omega$
is only a presymplectic form here, while it was a true symplectic form
