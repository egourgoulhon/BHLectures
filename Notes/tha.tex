...
For instance, one may conceive that some nonzero variation $\delta\w{g}$ in the space of solutions
...
Fortunately, the degeneracy directions of $\Omega$ are integrable in
submanifolds of $\FF$. Indeed, according to Frobenius theorem
...
degeneracy vector fields $X_1$ and $X_2$. This is easy to show: via the
identity (\ref{e:bas:Lie_commut}) and the Leibniz rule, we get
...
since $\Dd\Omega = 0$ (Property~\ref{p:tha:presymplectic_form}) and
$\Omega(X_1, .) = 0$. Hence $\Omega([X_1, X_2], .) = 0$
and the degeneracy directions of $\Omega$ are integrable in a family
of submanifods foliating $\FF$.
