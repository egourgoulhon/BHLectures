...
Disregarding any matter field or extra scalar field for simplicity,
...
L = (16\pi)^{-1} R = (16\pi)^{-1} g^{\mu\nu} R_{\mu\nu}
 =  (16\pi)^{-1} g^{\mu\nu} R^\sigma_{\ \,\mu\sigma\nu},
\]
hence $L = (16\pi)^{-1} g^{\mu\nu} g^{\rho\sigma} R_{\rho\mu\sigma\nu}$,
which is of the form (\ref{e:tha:Lagrangian_diffeo_inv}).
\end{example}
...
\be \label{e:tha:def_Noether_current}
    \w{J}[\w{\xi}] := \w{\theta}\lld\w{g},\Lie{\xi}\w{g}\rld - \w{\xi}\cdot\w{L} ,
\ee
where $\w{\theta}\lld\w{g},\Lie{\xi}\w{g}\rld$ is the $(n-1)$-form obtained by setting the second
argument of the symplectic potential form $\w{\theta}\lld\w{g},\delta\w{g}\rld$
...
\be \label{e:tha:J_not_unique}
     \w{J'}[\w{\xi}] =  \w{J}[\w{\xi}]  + \dd \w{Y}\lld\w{g},\Lie{\xi}\w{g}\rld,
\ee
...
\be \label{e:tha:Q_not_unique}
    \w{Q'}[\w{\xi}] = \w{Q}[\w{\xi}] + \w{Y}\lld\w{g},\Lie{\xi}\w{g}\rld + \dd\w{Z}\lld\w{g},\w{\xi}] ,
\ee
where $\w{Y}\lld\w{g},\Lie{\xi}\w{g}\rld$ is any $(n-2)$-form that is linear in $\Lie{\xi}\w{g}$ and
$\w{Z}\lld\w{g},\w{\xi}] $ is any $(n-3)$-form that is linear in $\w{\xi}$.
\end{prop}
...
$\w{J}[\w{\chi}] := \w{\theta}\lld\w{g},\Lie{\chi}\w{g}\rld - \w{\chi}\cdot\w{L}
= - \w{\chi}\cdot\w{L}$, since $\Lie{\chi}\w{g}=0$ ($\w{\chi}$ Killing)
along with the linearity of $\w{\theta}$ imply $\w{\theta}\lld\w{g},\Lie{\chi}\w{g}\rld =0$.
...
From the spacetime symplectic potential $(n-1)$-form $\w{\theta}\lld\w{g},\delta\w{g}\rld$
...
\be \label{e:tha:def_Theta_X_theta}
    \langle \Theta, X \rangle\,  \delta\lambda := \int_{\Sigma} \w{\theta}\lld\w{g},\delta\w{g}\rld,
\ee
...
since $\w{\theta}\lld\w{g},\delta\w{g}\rld$ is a $(n-1)$-form on $\M$ and $\Sigma$
...
Since $\w{\theta}\lld\w{g},\delta\w{g}\rld$ is linear in its argument $\delta\w{g}$
(cf. Property~\ref{p:tha:var_Lagrangian}), we may rewrite (\ref{e:tha:def_Theta_X_theta}) as
\be \label{e:tha:Theta_X_theta_partial}
    \langle \Theta, X \rangle := \int_{\Sigma} \w{\theta}\Lld\w{g},\frac{\delta\w{g}}{\delta\lambda}\Rld .
\ee
...
$\w{L}(\lambda_1,\lambda_2) := \w{L}\lld\w{g}(\lambda_1,\lambda_2)]$.
