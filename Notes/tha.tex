...
\begin{example}[asymptotic behavior of the presymplectic potential form of general relativity]
...
\textnormal{(Wald\index[pers]{Wald, R.M.} \& Iyer\index[pers]{Iyer, V.} 1993, 1994
\cite{Wald93,IyerW94})}]
Let $(\M,\w{g})$ be a $n$-dimensional stationary spacetime governed by a diffeomorphism-invariant gravity theory. Let us assume that  $(\M,\w{g})$ contains a black hole, the
event horizon of which is a bifurcate Killing horizon with respect to the
Killing vector
\be
