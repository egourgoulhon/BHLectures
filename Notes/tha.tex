...
in formula~(\ref{e:tha:def_canonical_energy}), is the
...
(cf. Property~\ref{p:tha:Komar_Noether}). The latter is identical to the ADM
energy (cf. Property~\ref{p:sta:Komar_ADM_mass}). Hence
the contribution to $\mathcal{E}$ of the $\w{Q}\lld\w{\xi}\rld$ and
$-\w{\xi}\cdot\w{B}$ terms in Eq.~(\ref{e:tha:def_canonical_energy})
