...
the presymplectic potential current $(n-1)$-form (Property~\ref{p:tha:var_Lagrangian}).
\end{prop}
...
Let us denote by $X_{\w{\xi}}$ the vector field on the space $\FF$ of
asymptotically flat solutions to the field equations corresponding to
the diffeomorphisms generated by $\w{\xi}$, i.e. $X_{\w{\xi}}$ is the
