...
the differential form $\w{J}\lld\w{\xi}\rld$ is closed as soon as the equations of motion (\ref{e:tha:eom_E}) are
...
\ee
$\w{Q}\lld\w{\xi}\rld$ is called the \defin{Noether charge $(n-2)$-form of $\w{\xi}$}\index{Noether!charge!form}
...
along with $\dd \w{J}\lld\w{\xi}\rld = 0$ [Eq.~(\ref{e:tha:J_closed})] yields
\[
...
$\dd \w{Q}\lld\w{\chi}\rld = \w{J}\lld\w{\chi}\rld$ [Eq.~(\ref{e:tha:J_dQ})] gives
...
\ee
$\w{\omega}$ is a $(n-1)$-form on spacetime, which has a local dependence on the metric tensor $\w{g}$,
