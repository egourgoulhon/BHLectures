...
with $\th\neq \pi/2$ become
complete. But this extension cannot be $\M_{\rm III}$
...
The non-affinity coefficient of $\w{k}'$ is (cf. the notebook~??):
\be
...
of view of $\M_{\rm I}$. More precisely, let us consider the
extended spacetime $(\M\cup\M', \w{g})$ and endow it with the same conformal
