...
\begin{tdef}{extremal Kerr spacetime}{}
...
\begin{tprop}{extremal Kerr metric as a solution to the vacuum Einstein equation}{}
The metric $\w{g}$ of the extremal Kerr spacetime is a solution to the
...
\begin{tprop}{principal null geodesics of the extremal Kerr spacetime}{}
\begin{itemize}
...
\begin{tprop}{$\Hor$ as a degenerate Killing horizon}{exk:H_degenerate_KH}
...
\begin{tprop}{black hole region in the extremal Kerr spacetime}{}
...
\subsection{Extension of \texorpdfstring{$\M_{\rm I}$}{MI} for complete outgoing principal null geodesics}
...
i.e. such that the conformal infinity $\scri$ is constituted by
...
\begin{tprop}{white hole region in the extended extremal Kerr spacetime}{}
...
\begin{tprop}{domain of outer communications}{}
...
\begin{tprop}{maximal analytic extension of the extremal Kerr spacetime}{}
...
AdS$_{4}$ metric in Poincaré coordinates\index{Poincaré!coordinates on AdS$_n$}, presented in Example~\ref{x:neh:AdS}, noticing that both the Poincaré horizon in AdS$_4$
...
(\ref{e:glo:AdS4}), with the changes of notation $y\leftrightarrow r$
...
there is one at $r=0$ in (\ref{e:glo:AdS4}) and the latter is such that AdS$_4$ cannot
...
\begin{tprop}{NHEK metric as a solution of the vacuum Einstein equation}{}
...
\begin{tprop}{angular momentum of NHEK spacetime}{}
...
As in the AdS$_4$ case presented in Example~\ref{x:glo:AdS}, it is quite natural to introduce
\be
    \chi := \arctan y \quad\iff\quad y =: \tan\chi
\ee
so that\footnote{In Example~\ref{x:glo:AdS}, the range of $\chi$ was only
$(0,\pi/2)$
...
\begin{tprop}{isometry group of NEHK spacetime}{}
The isometry group
...
\subsection{Applications} \label{s:exk:applications}
