...
with the time slicing associated to the 3+1 Kerr coordinates $(\ti, r,\th,\tph)$.
\textsl{[Figure generated by the notebook \ref{s:sam:Kerr_extremal}]}
}
\end{figure}
...
Carter-Penrose diagram of the extremal Kerr spacetime $(\M,\w{g})$, with
the time slicing associated to Boyer-Lindquist coordinates $(t,r,\th,\ph)$.
\textsl{[Figure generated by the notebook \ref{s:sam:Kerr_extremal}]}
}
\end{figure}
