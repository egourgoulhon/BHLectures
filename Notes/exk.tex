...
while along $\Li^{{\rm out},\Hor}_{(\th,\psi)}$, such an affine parameter is $\ti$. The null tangent vector $\wl$ along $\Li^{\rm out}_{(u,\th,\tilde{\tph})}$ and $\Li^{{\rm out},\Hor}_{(\th,\psi)}$
...
except for $\ti$ being an affine parameter along $\Li^{{\rm out},\Hor}_{(\th,\psi)}$, which will
