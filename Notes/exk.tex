...
%\includegraphics[height=0.35\textheight]{exk_NH_region.pdf}
...
\end{minipage}
\caption[]{\label{f:exk:Kerr_NHEK_spacetimes} \footnotesize
Kerr spacetime (left) and NHEK spacetime (right)
