...
The first direction, which implies $\varpi \to +\infty$ and $z \to +\infty$
...
spacelike infinity\index{spacelike!infinity} point $i_0$ at the right-most corner
of the Carter-Penrose diagram of Fig.~\ref{f:exk:CPdiag_BL}.

The second direction, $r\to m$, corresponds to
