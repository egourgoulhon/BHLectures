...
\be \label{e:exk:def_global_NHEK}
    ...
    \end{array}\right.
\ee
Beside the AdS$_{2}$-type transformation for $(\tau,y)$, the new azimuthal
coordinate $\psi$ is introduced to insure $\D\Phi + R \,\D T = \D\psi + y \, \D\tau$.
In terms of the global NHEK coordinates $(Y^\alpha)=(\tau,y,\theta,\psi)$, the NHEK
...
Given the similarities with the AdS spacetime, which is a maximally symmetric spacetime,
it should not come as a surprise that the NHEK spacetime $(\mathscr{N},\w{h})$
