...
generated by these Killing vectors is thus 4-dimensional. This is
...
showed that the near-horizon limit brings
the Reissner-Nordström metric to the metric of
\emph{Bertotti-Robinson\index{Bertotti-Robinson spacetime} spacetime}.
The latter is the product space $\mathrm{AdS}_2\times\SS^2$ and constitutes a static solution of
...
The NHEK metric has been rediscovered by James Bardeen\index{Bardeen, J.M.} and Gary Horowitz\index{Horowitz, G.T.} in 1999 \cite{BardeH99}. They deduced it from the Boyer-Lindquist expression of the extremal Kerr metric by performing the change of coordinates (\ref{e:exk:def_R_T_Phi})-(\ref{e:exk:R_T_Phi_BL}) and taking the limit $\veps\to 0$, as presented in
...
The NHEK geometry is at the core of the so-called \emph{Kerr/CFT correspondence}\index{Kerr/CFT correspondence}, initiated by M.~Guica, T.~Hartman, W. Song and A. Strominger in 2009 \cite{GuicaHSS09}, which conjectures that that quantum gravity\index{quantum!gravity}
