...
More recently, it has been shown that \emph{non-axisymmetric} scalar modes are unstable along $\Hor$ and have a growth rate higher than the axisymmetric perturbations considered by
Aretakis, their transversal first derivative growing as ${\ti}^{\,1/2}$ along $\Hor$ \cite{CasalGZ16,Gajic23}.
