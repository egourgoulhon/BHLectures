...
degenerate, in the sense defined in Sec.~\ref{s:neh:classif_KH}, i.e. it has a
vanishing surface gravity $\kappa$. Another specific property is the enlarged
symmetry group for the geometry near the horizon: there are four independent Killing
vectors instead of two.
...
via formulas (\ref{e:exk:ttt_t_ti}) and (\ref{e:exk:def_ttph}).
...
\be
    \M_0 := \M \cup \M' = \M_{\rm I} \cup \M_{\rm III} \cup \M'_{\rm III} \cup \Hor \cup \Hor' .
\ee
...
\end{align}
\end{subequations}
where $T_0(u,v)$ and $X_0(u,v)$ are defined by Eq.~(\ref{e:exk:def_T0_X0})
...
\ee
The last equation is obtained by combining Eqs.~(\ref{e:exk:def_v}) and (\ref{e:exk:ttt_t_ti}).


It appears that the Killing horizon $\Hor'$ is actually a white hole horizon from the point
...
i.e. formed by the same future and past null infinities
$\scri^+$ and $\scri^-$ at the boundary of $\M_{\rm I}$. It appears then
that $\M'_{\rm III}$ is the interior of a white hole\index{white hole} region, the boundary of which
is $\Hor'$.
