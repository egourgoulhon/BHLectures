...
on arXiv in 2012, but was published in 2015.} that, contrary to what happens
for subextremal Kerr black holes ($a<m$), axisymmetric scalar perturbations
(solutions of the wave equation $\Box_{\w{g}} \Psi = 0$)
have transverse second and higher derivatives\footnote{By \emph{transverse derivative}
...
that blow up (generically like $\ti$) when $\ti\to+\infty$ along the event horizon $\Hor$ of an extremal Kerr black hole,
while $\Psi$ itself decays like $\ti^{-1/2}$ \cite{Areta15}
...
and Peter Zimmerman\index[pers]{Zimmerman, P.} have shown that
\emph{non-axisymmetric} scalar modes are unstable along $\Hor$ and have a growth rate higher than the axisymmetric perturbations considered by
Aretakis, with a transverse \emph{first} derivative growing like ${\ti}^{\,1/2}$ along $\Hor$ \cite{CasalGZ16}. This has been recently confirmed by a rigorous mathematical analysis by
Dejan Gajic\index[pers]{Gajic, D.} \cite{Gajic23}.
The stability studies have been extended to electromagnetic and gravitational perturbations
by Gralla and Zimmerman in 2018 \cite{GrallZ18}, who showed that the blow up of the
perturbation derivatives
can be considered as a critical phenomenon associated with the
