...
\subsection{Geometry of the near-horizon region}
...
of the components (\ref{e:neh:AdS:metric_Poincare}) of
...
the rotation axis ($\sin\th=0$) is exactly the metric of AdS$_{2}$.
