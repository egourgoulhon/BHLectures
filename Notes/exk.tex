...
\section{Near-horizon extremal Kerr (NHEK) geometry}
...
the coordinate $\tau$ is actually restricted to $(-\pi/2, \pi/2)$ on $\M$. We may therefore
...
A third symmetry apparent on the line element (\ref{e:exk:NEHK_metric})
...
\ee
The Boyer-Lindquist expression of $\w{\xi}_3$ is found to be
\be
