...
\be
     I(b, t_\Obs)   = (1 + z)^{-4} \int_0^{+\infty}
        I_\nu^{\rm em}\left(\Theta_{\rm em}, t_{\rm em}, \nu_{\rm em}\right) \, \D \nu_{\rm em} .
\ee
In view of the redshift behavior (\ref{e:lem:central_redshift}), we deduce
...
\be
  I(0, t_\Obs)  \underset{t_\Obs \to +\infty}{\sim} I_0\,
...
$\D\Omega = b/r_\Obs^2\, \D b\, \D\phi$, we get
\be
...
\be
    F(t_\Obs) \sim F_0 \, \mathrm{e}^{- (t_\Obs - t_\Obs^*)/(3\sqrt{3} m)} .
\ee
