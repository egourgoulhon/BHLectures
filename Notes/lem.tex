...
is a piece of Schwarz\-schild spacetime. Note that this implies that the
...
in our way from the Lemaître coordinates to the Schwarzschild-Droste coordinates,
...
\begin{hist}
The Lemaître-Tolman system (\ref{e:lem:LTeqs}) has been first published
...
to studies by Richard Tolman\index{Tolman, R.C.} in 1934 \cite{Tolma34}
and by Hermann Bondi in 1947 \cite{Bondi47}. As discussed by
Krasi\'nski \cite{Krasi97}, the origin of this misnomer is not clear,
since Tolman fully acknowledge Lemaître's work \cite{Lemai32} in his
article \cite{Tolma34}. Actually Tolman met Lemaître in 1932-33 during
the latter's trip to United States \cite{Eisen93}.

We follow the suggestion of Pleba\'nski \& Krasi\'nski \cite{PlebaK06}
to call these solutions \emph{Lemaître-Tolman}
