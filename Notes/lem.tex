...
the radius of the disk image shrinks from $b_{\rm m} = r_0 / \sqrt{1 - 2m/r_0}$
[Eq.~(\ref{e:lem:OS:bmax_static})]
to $b_{\rm m} = 3\sqrt{3} \, m$ [Eq.~(\ref{e:lem:OS:bmax_final})].
...
\ee
On the other side, the value of $t_\Obs^{**}$ is obtained by setting
$b=b_0:= r_0/\sqrt{1 - 2m/r_0}$ [the value~(\ref{e:lem:OS:bmax_static})],
