...
Let us consider a 2-dimensional surface $\Sp$ at constant coordinates $(\eta,\chi)$
inside the collapsing star. It appears as a point in the spacetime diagrams of
Fig.~\ref{f:lem:OS:diag_trapped}. The surface $\Sp$ is spanned by the coordinates $(\th,\ph)$
and the metric $\w{q}$ induced by $\w{g}$ on $\Sp$ is readily
...
the outgoing one, represented by a solig green line in Fig.~\ref{f:lem:OS:diag_trapped}
...
\be
     ...
     \qand
     \theta_{(\w{k})} = \frac{1}{2} \Lie{\w{k}}  \ln q .
\ee
