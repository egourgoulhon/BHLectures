...
across the event horizon of Schwarzschild spacetime, contrary to the
...
plays a negligible dynamical role, so that the pressureless (dust) approximation
...
As we are going to see, the homogeneous dust star collapse is obtained by the
...
adopted in this chapter. This leads to
