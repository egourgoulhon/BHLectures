...
is the hypersurface $\mathscr{T}$
defined by $\eta = \pi - 2\chi$. As we shall see in
Chap.~\ref{s:loc}, it is called a \emph{future inner trapping horizon}.
It is drawned as a dotted blue line in Figs.~\ref{f:lem:OS:diag_int_EF}
and \ref{f:lem:OS:diag_trapped}.
