...
\be \label{e:lem:OS:sin_chis_m0_r0}
    \sin\chi_{\rm s} = \sqrt{\frac{2 m_0}{r_0}} .
\ee
...
\ee
It is clear that these three curvature invariants diverge when $\eta\to \pi$,
or equivalently, when $r_{\rm s}(\tau)\to 0$.

\subsection{Black hole formation}


\subsection{Tapped surfaces}
