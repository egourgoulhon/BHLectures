...
\begin{tprop}{Lemaître-Tolman system\index{Lemaitre-Tolman system@Lemaître-Tolman system}}{}
...
\begin{tprop}{solution for spherical dust collapse}{}
...
\begin{tprop}{Jebsen-Birkhoff theorem\index{Birkhoff's theorem}\index{Jebsen-Birkhoff theorem}}{lem:Birkhoff}
...
\ee
\begin{texample}{}{lem:OS:tau_end_plot}
...
\begin{texample}{collapse time for various astrophysical objects}{lem:OS:tau_end_astro}
...
\begin{texample}{}{lem:OS:tau_star_chis4}
...
\begin{texample}{values of $\tau_*$ for various astrophysical objects}{lem:OS:tau_star_astro}
...
\begin{tprop}{birth and growth of the event horizon}{}
\begin{itemize}
...
\begin{texample}{horizon birth for various astrophysical objects}{lem:OS:tau_hb}
...
$\rho_{\rm hb} < 0.02 \, m^{-2}$.
Hence
\begin{tprop}{matter density at the horizon's birth}{}
...
\begin{texample}{}{lem:OS:rho_hb_water}
...
\begin{texample}{values of $\rho_{\rm hb}$ for various astrophysical objects}{}
...
\begin{tprop}{trapped surfaces}{lem:trapped_surfaces}
...
$\delta\tau = \tau_{\rm end}/8 = \pi\sqrt{2} m / 4$ (cf. Example~\ref{x:lem:OS:tau_end_plot}). One sees graphically that the signals are received by $\Obs$
...
\begin{tprop}{apparent freeze of the collapse}{}
...
\begin{tprop}{apparent size of the collapsing star}{}
\begin{itemize}
...
\ee
Hence we conclude:
\begin{tprop}{exponential growth of the central redshift}{}
...
\begin{tprop}{photons forming the image's rim}{}
...
Hence
\begin{tprop}{constant redshift at the image's rim}{}
