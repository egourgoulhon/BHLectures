...
\include{def}  % The concept of black hole 1: Horizons and null hypersurfaces

\chapter{The concept of black hole 2: The global view} \label{s:glo}

\chapter{Schwarzschild black hole} \label{s:sch}

\chapter{Kerr black hole} \label{s:ker}
