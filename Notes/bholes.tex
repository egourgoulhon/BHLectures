...
{\par\medskip}
%\tcolorboxenvironment{example}{breakable, enhanced, colback=green!5!white,
%left=0.5ex, right=0.5ex, top=0.5ex, bottom=0.5ex, boxsep=0.5ex,
%fontupper=\small}

%\newtcolorbox[auto counter,counter within=chapter]{texample}[1][]{%
...
{breakable, enhanced, colback=green!5!white, colframe=green!50!black,%
left=0.5ex, right=0.5ex, top=0.5ex, bottom=0.5ex, boxsep=0.5ex,%
