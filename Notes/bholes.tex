...
%\theoremstyle{break}
%\newmdtheoremenv[backgroundcolor=gray!10!white,roundcorner=5pt,hidealllines=true,frametitlerule=true]{prop}{Proposition}[chapter]
%\newmdtheoremenv[backgroundcolor=gray!10!white,roundcorner=5pt,frametitlerule=true]{prop}{Proposition}[chapter]
...
\mdtheorem[style=propstyle]{prop}{Proposition}[chapter]
...
{\Huge --- DRAFT ---}\\[2ex]
{version of 18 September 2022}\\[2ex]
