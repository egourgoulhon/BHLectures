...
{\Huge --- DRAFT ---}\\[2ex]
{version of 30 January 2023}\\[2ex]
...
\indexprologue{\small Only names of persons mentioned explicitly in the text, mostly
in the historical notes, appear here}
\printindex[pers]

\cleardoublepage
\phantomsection % to have correct hyperlink to index in TOC

\indexprologue{Ceci est un test}
\printindex
