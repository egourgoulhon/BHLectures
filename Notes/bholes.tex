...
\usepackage{tocbibind} % bibliographie et index dans la table des matières
\usepackage{fancyhdr}
\usepackage{minitoc}
\usepackage{graphicx}
\usepackage{color}
...
{\Large IAP, March-April 2016} \\[1ex]
{\Large CP3, UCL, November 2016}\\[8ex]
Éric Gourgoulhon \\
