...
\usepackage[theorems,breakable,skins]{tcolorbox}  % framed theorems
                                                  % skins --> option "enhanced" in \newtcbtheorem
...
% Reglages:
%
\hypersetup{pdftitle={Lectures on black hole theory},
...
\setlength{\textheight}{23cm} % hauteur corps texte = \textheight
...
{\par\smallskip}
\tcolorboxenvironment{notation}{colback=olive!5!white}

%\theoremstyle{definition} % upright text in theorems

\newtcbtheorem[number within=chapter]{tprop}{Property}%
{breakable, enhanced, colback=red!5!white, colframe=red!50!black, fonttitle=\bfseries}{p}

\newtcbtheorem[number within=chapter, use counter from=tprop]{tlemma}{Lemma}%
{breakable, enhanced, colback=red!5!white, colframe=red!50!black, fonttitle=\bfseries}{p}

\newtcbtheorem[number within=chapter]{tdef}{Definition}%
{breakable, enhanced, colback=olive!5!white, colframe=olive!80!black, fonttitle=\bfseries}{d}

\newtcbtheorem[number within=chapter]{texample}{Example}%
{breakable, enhanced, colback=green!5!white, colframe=green!40!black,%
left=0.5ex, right=0.5ex, top=0.5ex, bottom=0.5ex, boxsep=0.5ex,%
fonttitle=\bfseries, fontupper=\small}{x}

\newtcolorbox{hist}[1][]{title=Historical note \ifthenelse{\equal{#1}{}}{ }{: #1},%
breakable, enhanced, colback=PaleTurquoise3!5!white, colframe=PaleTurquoise3!50!black,%
left=0.5ex, right=0.5ex, top=0.5ex, bottom=0.5ex, boxsep=0.5ex,%
fonttitle=\bfseries, fontupper=\small}

%\newtcbtheorem[number within=chapter]{thist}{Historical note}%
%{breakable, enhanced, colback=PaleTurquoise3!5!white, colframe=PaleTurquoise3!50!black,%
%left=0.5ex, right=0.5ex, top=0.5ex, bottom=0.5ex, boxsep=0.5ex,%
%fonttitle=\bfseries, fontupper=\small}{h}
...
{\Huge\textbf{Lectures on black hole theory}}\\[2ex]
...
{\Huge --- DRAFT ---}\\[2ex]
{version of 14 September 2026}\\[2ex]
...
\setcounter{tocdepth}{1}  % 1 = only chapters and sections in TOC
\tableofcontents
...
\include{glo}  % Defining a black hole

\include{nul}  % Geometry of null hypersurfaces

\include{neh}  % Non-expanding horizons and Killing horizons
...
\include{vai}  % Black hole formation 2: Vaidya collapse

\include{evo}  % Evolution and thermodynamics of black holes

\include{tha}  % Black hole thermodynamics beyond general relativity
