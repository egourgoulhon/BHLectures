...
\defin{O'Neill canonical vector field}\index{O'Neill canonical vector}\index{canonical!vector field (O'Neill)} \cite{ONeil95}
\be
    \w{V} := (r^2 + a^2) \, \w{\xi} + a \, \w{\eta} .
\ee
It is an easy exercise to show, by means of the metric components (\ref{e:ker:metric_BL}), that the scalar
square of $\w{V}$ is
\be
    \w{g}(\w{V},\w{V}) = - \rho^2 \Delta .
\ee
Accordingly, $\w{V}$ is timelike in $\M_{\rm I} \cup \M_{\rm III}$, spacelike in $\M_{\rm II}$
and null on $\Hor$ and $\Hor_{\rm in}$. Moreover, in $\M_{\rm I} \cup \M_{\rm III}$,
...
We can then apply Lemma~1 of Sec.~\ref{s:fra:time_orientation} with $\w{V}$
in $\M_{\rm I} \cup \M_{\rm III}$:
\[
   \w{p} \ \mbox{future-directed in} \ \M_{\rm I} \cup \M_{\rm III} \iff \w{g}(\w{V},\w{p}) < 0
