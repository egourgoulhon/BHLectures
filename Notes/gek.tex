...
form $\Phi = \Phi_0(r,\th) \mathrm{e}^{\mathrm{i}(\omega t - m \ph)}$,
it can be shown that $E_*<0$ is equivalent to \cite{Carte79c,Wald84,LasotGATN14}
\be
    0 < \omega < m \Omega_{\Hor} .
\ee
...
William Press\index[pers]{Press, W.H.} and Saul Teukolsky\index[pers]{Teukolsky, S.A} in the same year \cite{PressT72}.
The term \emph{superradiant scattering} has been coined by these last two authors.
\end{hist}
