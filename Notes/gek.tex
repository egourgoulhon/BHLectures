...
\begin{figure}
\centerline{\includegraphics[width=0.6\textwidth]{gek_Z1.pdf}}
...
the quadratic equation $(r_{\rm ISCO}^\pm)^2 - 6 m r_{\rm ISCO}^\pm \pm 8 a \sqrt{m r_{\rm ISCO}^\pm} - 3 a^2 = 0$ in $a$
...
\subsection{Astrophysical application: energy radiated from an accretion disk around a black hole}
...
The values of $\veps$ and $\ell$ at the ISCO depend on $a$; they take a simple
form when expressed in terms of $r_{\rm ISCO}^\pm$, instead of directly $a$:
...
\begin{align}
    ...
    \qand
    \ell_{\rm ISCO}^+ = \frac{2 m}{\sqrt{3}} \simeq 1.15 \, m \qquad (a=m)  \\
