...
axis, without reaching the equator; one has either $\th\in[0,\th_1]$ or
$\th\in [\pi - \th_1,\pi]$, with the turning point value
$\th_1 := \arccos\sqrt{|Q|/(a^2(E^2 - \mu^2))} < \pi/2$ (cf. the trajectories $Q=Q_1$ in Fig.~\ref{f:gek:th_pot_L_0}, right).
...
\be \label{e:gek:th0_a2E2mu2_zero}
     \encadre{\th_0 = \arccos\sqrt{\frac{Q}{L^2 + Q}} . }_{\, a^2 (E^2 - \mu^2) = 0}
\ee
...
\be \label{e:gek:th0_L_zero}
   \encadre{ \th_0 = \th_1 = \arccos \sqrt{\frac{Q}{a^2 (\mu^2 - E^2)}} . }_{\, L=0}
\ee
...
More precisely, for $Q > 0$ and $\mu^2 - E^2 > 0$, it leads to $\th_0$, while
for $Q<0$ and $\mu^2 - E^2 < 0$, it leads to $\th_1$.
...
\be \label{e:gek:th0_E_lt_mu}
    \encadre{ \th_0 = \arccos \sqrt{ \frac{1}{2} \left[ 1 + \frac{L^2 + Q}{a^2 (\mu^2 - E^2)}
...
\be \label{e:gek:th0_E_gt_mu}
    \encadre{\th_0 =  \arccos  \sqrt{   \frac{1}{2} \left[ 1 - \frac{L^2 + Q}{a^2 (E^2 - \mu^2)}
...
\be \label{e:gek:th1}
    \encadre{\th_1 =  \arccos  \sqrt{  \frac{1}{2} \left[ 1 - \frac{L^2 + Q}{a^2 (E^2 - \mu^2)}
        - \sqrt{ \left[1 - \frac{L^2 + Q}{a^2 (E^2 - \mu^2)}\right] ^2
        + \frac{4Q}{a^2 (E^2 - \mu^2)}} \right]  } } .
\ee
\end{itemize}
...
and
\be
    T_1(r) := \frac{r^2 + a^2}{r^2 - 2 m r + a^2} [\veps (r^2 + a^2)  - a \ell],\qquad
    T_2(\th) := - a^2 \veps \sin^2\th,
\ee
\be
    \Phi_1(r) := \frac{a}{r^2 - 2 m r + a^2}\left[\veps (r^2 + a^2) - a \ell \right],\qquad
...
\be
    \encadre{ \Lambda_\th = 2 \int_{\th_0}^{\pi-\th_0}
