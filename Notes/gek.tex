...
Consequently, the first permitted range for circular orbits in (\ref{e:gek:range_circ_plus}) lies
...
\be
    \veps_{\pm} = \frac{r_0^2 -2m r_0 \pm a \sqrt{mr_0}}{r_0\sqrt{r_0^2 - 3m r_0 \pm 2 a \sqrt{m r_0}}} ,
\ee
\be
