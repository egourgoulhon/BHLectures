...
\ee
where $R(r)$ is the following 4th order polynomial of $r$:
...
& \encadre{ \rho^2 \derd{r}{\lambda} = \pm \sqrt{ R(r) } } \label{e:gek:drdl}\\
& \encadre{ \rho^2 \derd{\th}{\lambda} = \pm \sqrt{\Theta(\th)} } \label{e:gek:dthdl}\\
...
& \encadre{ \derd{r}{\lambda'} = \pm \sqrt{ R(r) } } \label{e:gek:drdl_Mino}\\
& \encadre{ \derd{\th}{\lambda'} = \pm \sqrt{\Theta(\th)} } \label{e:gek:dthdl_Mino}\\
...
\be
    \lambda' = \pm \int_{r_0}^r \frac{\D r}{\sqrt{R(r)}} .
\ee
...
\section{Generic properties of geodesics}
