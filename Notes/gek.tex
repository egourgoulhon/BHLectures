...
\end{figure}
Given the definition (\ref{e:gek:def_tilde_l}) of $\tilde{\ell}$
and the expression (\ref{e:gek:veps_circ}) of $\veps_\pm$, these two solutions
...
(resp. \defin{retrograde}\index{retrograde}\index{retrograde orbit}).
...
a simple expression:
\[
    \mathcal{V}''(r_0) = \frac{2m}{r_0^3} \left( 1 - \frac{\tilde{\ell}}{r_0^2} \right) .
\]
