...
The possibility of having negative-energy particles\index{negative-energy particle}\index{particle!negative-energy --} in the outer ergoregion $\mathscr{G}^+$ allows
for energy extraction from a rotating black hole.
Indeed, let us consider a particle $\mathscr{P}$, of 4-momentum $\w{p}$,
in free fall from infinity into the outer ergoregion. At some point $A\in \mathscr{G}^+$, the particle $\mathscr{P}$
splits (or decays) into two particles: $\mathscr{P}'$, of 4-momentum $\w{p'}$, which
subsequently exits the ergoregion and leaves to infinity, and $\mathscr{P}''$, of 4-momentum $\w{p''}$, which falls into the black hole (cf. Fig.~\ref{f:gek:penrose_proc}).
We assume that, once created, all particles $\mathscr{P}$, $\mathscr{P}'$,
and $\mathscr{P}''$ are subject only to gravitation, so that their worldlines are
geodesics. Let us define the \emph{energy gain} in the above scenario by
...
of $\mathscr{P}$ and $\mathscr{P}'$, we have
...
can occur for any stationary rotating body (not necessarily a black hole) that
is endowed with an ergoregion that one can visit from infinity.
\end{remark}

Since the particle $\mathscr{P}''$ is assumed to fall into the black hole region,
...
energy-momentum vector $\w{p''}$ is necessarily a future-directed causal vector,
which is transverse to $\Hor$ at $B$ (for $\mathscr{P}''$ is crossing $\Hor$)
...
We thus get
\be
    \encadre{E'' - \Omega_{\Hor} L'' > 0 }.
\ee
Consequently, if a Penrose process occurs ($\Delta E >0$), we have
$\Omega_{\Hor} L'' < E'' < 0$. We conclude:

\begin{prop}[Penrose process]
In a Penrose process, both the conserved energy $E''$ and the
conserved angular momentum $L''$ of the particle falling into the black hole
are negative, $L''$ being bounded from above by $E''/\Omega_{\Hor}$.
\end{prop}
