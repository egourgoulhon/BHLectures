...
\begin{align}
 ...
 + a \dashint_{\th_0}^\th ( L - a E \sin^2\bar{\th} ) \frac{\eps_\th \, \D \bar{\th}}{\sqrt{\Theta(\bar{\th})}} \\
 & \ph - \ph_0 = a \dashint_{r_0}^r  \frac{(\bar{r}^2 + a^2)E - a L}{\bar{r}^2 - 2m \bar{r} + a^2}
    \frac{\eps_r \, \D \bar{r}}{\sqrt{R(\bar{r})}}
    + \dashint_{\th_0}^\th \left( \frac{L}{\sin^2\bar{\th}} - a E  \right) \frac{\eps_\th \, \D \bar{\th}}{\sqrt{\Theta(\bar{\th})}} .
\end{align}
\end{subequations}
\end{greybox}
