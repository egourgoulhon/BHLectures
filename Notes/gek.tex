...
release acheived through thermonuclear reactions: the most efficient
...
energy is taken from the thermal energy of the disk, while in the latter
the energy is extracted from the ``rotational energy'' of the black hole
and requires the existence of an ergoregion.
\end{remark}
