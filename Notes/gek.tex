...
(\ref{e:gek:dthdl_Mino}), since this provides some usefull constraints
...
Hence we conclude:
\begin{greybox}
A geodesic with $|E|<\mu$ is necessarily timelike ($\mu >0$),
is confined to the region $r\geq 0$ of Kerr spacetime
and cannot reach arbitrary large values of $r$. It is called a
\defin{geodesic with a bound orbit}\index{geodesic!with a bound orbit},
or in short, a \defin{bound geodesic}. Such a geodesic has necessarily a
non-negative Carter constant $Q$.
\end{greybox}
