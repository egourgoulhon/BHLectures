...
are called \defin{prograde circular orbits}\index{prograde!circular orbit};
\item orbits of the $(\eps_-,\ell_-)$ family
are called \defin{retrograde circular orbits}\index{retrograde!circular orbit};
...
function is depicted in Fig.~\ref{f:gek:circ_orb_isco}.
