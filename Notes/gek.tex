...
\begin{hist}
David Lynden-Bell\index[pers]{Lynden-Bell, D.} \cite{Lynde69} was the first to suggest, in 1969,
...
up to $0.423$ for $a=m$ [Eq.~(\ref{e:gek:Erad_a_1})] (the number $0.432$ given in Ref.~\cite{Barde70a}
is a typo and must be read as $0.423$).
\end{hist}
