...
These notes provide an introduction to the theory of black holes within
general relativity and other metric theories of gravity.
The prerequisite is a basic knowledge of general relativity, typically at the level of a master's
course.

Although some observational topics are discussed, notably the so-called \emph{black hole
images}, the text focuses on theoretical aspects, such as the mathematical definition of
a black hole and general properties that can be established under various assumptions,
including famous ``black hole theorems''.
In particular, black hole thermodynamics is discussed in details, as well as the quasi-local approach to black holes.
The text also contains a detailed presentation of standard exact solutions within general relativity,
both for stationary black holes (Schwarzschild, Kerr) and
dynamical ones (Oppenheimer-Snyder, Vaidya).
For the sake of applications to theoretical physics, the spacetime dimension is kept general; it
is set to 4 only in some specific chapters (e.g. those about Schwarzschild or Kerr black holes).
Similarly, it will be made clear whether a result is valid only in general relativity (i.e. relies on the Einstein equation) or remains true in modified theories of gravity.

Despite the length of this document, two important topics of black hole theory are not covered.
First of all, black hole perturbation theory is not treated, despite of being pivotal
to the growing field of gravitational wave astronomy. Probably such a topic would deserve
a whole volume by its own. Secondly,
quantum aspects are almost not discussed, except briefly in the context of Hawking radiation and black hole thermodynamics (Chap.~\ref{s:evo}).


These notes are built upon lectures given
\begin{itemize}
...
{\footnotesize\url{https://www.jinr.ru/posts/lecture-course-geometry-and-physics-of-black-holes/}}
...
Chru\'sciel (2002, 2005) \cite{Chrus02, Chrus05}, Chru\'sciel, Lopes Costa \& Heusler (2012) \cite{ChrusLH12} and Pound \& Wardell (2021) \cite{PoundW21}
and recent monographs with various chapters about black holes:
Shibata (2016) \cite{Shiba16}, Andersson (2020) \cite{Ander20} and Friedman (2026) \cite{Fried26}.
In addition, let us point out other lecture notes on black holes:
Hawking (1994) \cite{Hawki94,HawkiP15}, Jacobson (1996) \cite{Jacob96}, Townsend (1997) \cite{Towns97},
...
and Reall (2024) \cite{Reall24b}.

The history of black holes in theoretical physics and astrophysics is
rich and fascinating. It is however not discussed here, except in some
...
Ted Jacobson, Zeynep Su Koç, Michel Le Bellac, Alexandre Le Tiec,
Jean-Philippe Nicolas, Jordan Nicoules, Micaela Oertel,
Paul Ramond, Nicolas Seroux, Jacques Smeets, Sashwat Tanay, Irene Urso and Frédéric Vincent
...
The \LaTeX{} sources are available on the git repository
\begin{center}
\url{https://github.com/egourgoulhon/BHLectures}
\end{center}
