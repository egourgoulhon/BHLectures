...
Although some observational aspects are discussed, notably the so-called \emph{black hole
images}, the text focuses on theoretical topics, such as the mathematical definition of
...
For the sake of applications to theoretical physics, the spacetime dimension $n$ is kept general. Similarly, it will be made clear whether a given result is valid only in general relativity (i.e. relies on the Einstein equation) or remains true in modified theories of gravity.
...
Andersson (2020) \cite{Ander20}, Friedman (2026) \cite{Fried26} and Shibata (2016) \cite{Shiba16}.
