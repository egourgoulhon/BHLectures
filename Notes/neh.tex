...
\label{p:neh:kappa_along_field_lines}
On any Killing horizon $\Hor$, the non-affinity coefficient $\kappa$ associated
to the Killing vector [Eq.~(\ref{e:neh:xi_nab_xi_kappa})] is constant along the null geodesic generators of $\Hor$, i.e.
...
To establish that $\kappa$ is contant is constant over $\Hor$, there remains to prove
that $\kappa$ does not vary from one null geodesic generator to another.
To this aim, let us consider a complete cross-section
