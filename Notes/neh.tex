...
To prove that this is not the case, let us consider a cross-section
$\Sp$ of $\Hor$ and show that $\kappa$ is constant over $\Sp$. The starting
...
The term $\nabla_\mu \Theta^\mu_{\ \, \nu}$ requires some special treatment though, because it potentially
involves derivatives of $\vw{\Theta}$ in directions transverse to $\Hor$. Let us then introduce
...
The reason is that ${}^{\Hor}\!\w{\omega}$ is a geometric quantity intrinsic to
$\Hor$ and $\wl$, independent of $\w{k}$ and hence of the cross-section $\Sp$
(cf. Property~\ref{p:neh:Hnab_l}).
...
term in the left-hand side of Eq.~(\ref{e:neh:zeroth_law_step2}) vanishes and we are
left with
