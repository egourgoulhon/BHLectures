...
$(x^\alpha)=(\tau,r,\th,\ph)$ are given by
\be \label{e:neh:AdS4}
    g_{\mu\nu} \D x^\mu \D x^\nu = \ell^2 \left[ - (1 + r^2) \, \D \tau^2
    + \frac{\D r^2}{1 + r^2} + r^2 \left( \D\th^2 + \sin^2\th \, \D\ph^2 \right) \right] ,
\ee
...
Yet another coordinate system commonly used in AdS$_{4}$ is the \defin{Poincaré coordinates}\index{Poincaré!coordinates on AdS$_n$} $(t,x,y,u)$. These coordinates cover only a subpart
