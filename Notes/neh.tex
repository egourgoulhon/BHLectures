...
its null normals and whose cross-sections are
closed (compact without boundary\footnote{Cf. the discussion in Sec.~\ref{s:def:spacelike_sections}.}).
The closed aspect enforces the ``localized'' facet
in the naive definition of a black hole (Definition~\ref{d:glo:naive_BH}), while
the vanishing expansion reflects the equilibrium state.
