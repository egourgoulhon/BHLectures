...
Let us stress that the above definition captures only
...
The Schwarzschild horizon $\Hor$ considered in Examples~\ref{x:def:Schw_hor}, \ref{x:def:Schw_hor2},
...
with the complete cross-sections having the topology $\SS^2$ (cf. Example~\ref{x:def:Schw_hor4}).
...
\begin{tprop}{Killing horizons as non-expanding horizons}{}
