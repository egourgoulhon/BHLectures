...
other side:
\begin{greybox}
In the vicinity of a non-degenerate Killing horizon, the Killing vector field $\w{\xi}$ is timelike on side of $\Hor$, null on $\Hor$
...
\ee
We have $V>0$ and the vector field
\be
    \w{u} := \frac{1}{V}\, \w{\xi}
\ee
...
The unit vector field $\w{u}$ can be considered as the field of 4-velocities
of a family of observers, the worldlines of which are the field lines of $\w{\xi}$,
i.e. the orbits of the corresponding isometry group. The 4-acceleration
of these observers is
\bea
    \w{a} & := & \wnab_{\w{u}}\, \w{u} \nonumber \\
...
\]
Thanks to Killing equation (\ref{e:neh:Killing_equation}), we get
\[
    a_\alpha = - \frac{1}{V^2} \, \xi^\mu \nabla_\alpha \xi_\mu
        = - \frac{1}{2V^2} \, \nabla_\alpha (\xi_\mu \xi^\mu)
        = \frac{1}{2V^2} \, \nabla_\alpha V^2
