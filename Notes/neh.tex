...
orthogonal projection of $\w{W}$ onto $\Sp$, since we get from (\ref{e:neh:def_W_index})
\[
...
holds and we have, according to Eqs.~(\ref{e:neh:R_ll_W_l}) and (\ref{e:neh:R_l_l_zero}),
