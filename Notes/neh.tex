...
\ee
Note that the null dominant energy condition implies the null convergence condition
...
\[
    ...
    = - \w{R}(\wl, \w{v}) .
\]
If we assume the null dominant energy condition, the null convergence condition
